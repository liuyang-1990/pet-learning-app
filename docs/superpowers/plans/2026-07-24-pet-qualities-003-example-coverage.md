...
**Constraints:** Registry coverage rises from 2412 to 2462; accessible official rows from 2418 to at least 2468; qualities coverage from 100/406 to 150/406.

## Tasks

- [x] Add RED tests for the 50 terms from `extra` through `high jump`.
- [ ] Add `data/example-candidates/qualities-003.json` with promoted entries.
