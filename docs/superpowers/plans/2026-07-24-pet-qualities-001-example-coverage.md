...
**Constraints:** Registry coverage rises from 2312 to 2362; accessible official rows from 2318 to at least 2368; qualities coverage from 0/406 to 50/406.

## Tasks

- [x] Add RED tests for the 50 terms from `absent` through `clever`.
- [ ] Add `data/example-candidates/qualities-001.json` with promoted entries.
