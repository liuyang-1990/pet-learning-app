...
export function getReviewedWordExamples(): Record<string, WordExample> {
  return {
    ...
    "hi": {
      focusWord: "hi",
      sentence: "Hi, my name is Leo.",
      chinese: "hi = 你好；你好，我叫利奥。",
    },
    "him": {
      focusWord: "him",
      sentence: "I met him outside the library.",
      chinese: "him = 他；我在图书馆外遇见了他。",
    },
    "himself": {
      focusWord: "himself",
      sentence: "Ben fixed the bicycle himself.",
      chinese: "himself = 他亲自；本亲自修好了自行车。",
    },
    "his": {
      focusWord: "his",
      sentence: "That red backpack is his.",
      chinese: "his = 他的；那个红色背包是他的。",
    },
    "honestly": {
      focusWord: "honestly",
      sentence: "Honestly, I did not enjoy the film.",
      chinese: "honestly = 说实话；说实话，我不喜欢这部电影。",
    },
    "hopefully": {
      focusWord: "hopefully",
      sentence: "Hopefully, the weather will improve tomorrow.",
      chinese: "hopefully = 希望；希望明天天气会好转。",
    },
    "how": {
      focusWord: "how",
      sentence: "How did you travel to the island?",
      chinese: "how = 如何；你是如何去那座岛的？",
    },
    "however": {
      focusWord: "however",
      sentence: "The hotel was expensive; however, the service was excellent.",
      chinese: "however = 然而；这家酒店很贵，然而服务非常好。",
    },
    "howmuch": {
      focusWord: "how much",
      sentence: "How much does this jacket cost?",
      chinese: "how much = 多少钱；这件夹克多少钱？",
    },
    "if": {
      focusWord: "if",
      sentence: "Call me if you need any help.",
      chinese: "if = 如果；如果你需要帮助，请给我打电话。",
    },
    "in": {
      focusWord: "in",
      sentence: "The keys are in my bag.",
      chinese: "in = 在...里面；钥匙在我的包里。",
    },
    "including": {
      focusWord: "including",
      sentence: "Ten students, including Mia, joined the trip.",
      chinese: "including = 包括；包括米娅在内的十名学生参加了旅行。",
    },
    "incredibly": {
      focusWord: "incredibly",
      sentence: "The view from the mountain was incredibly beautiful.",
      chinese: "incredibly = 非常；山上的景色非常美丽。",
    },
    "indeed": {
      focusWord: "indeed",
      sentence: "The exam was difficult indeed.",
      chinese: "indeed = 的确；这次考试的确很难。",
    },
    "indoors": {
      focusWord: "indoors",
      sentence: "We stayed indoors because of the storm.",
      chinese: "indoors = 在室内；因为暴风雨，我们待在室内。",
    },
    "infact": {
      focusWord: "in fact",
      sentence: "I thought Leo was French, but in fact he is Belgian.",
      chinese: "in fact = 事实上；我以为利奥是法国人，但事实上他是比利时人。",
    },
    "infrontof": {
      focusWord: "in front of",
      sentence: "There is a bus stop in front of the school.",
      chinese: "in front of = 在...前面；学校前面有一个公交车站。",
    },
    "inink": {
      focusWord: "in ink",
      sentence: "Please complete the form in ink.",
      chinese: "in ink = 用墨水；请用墨水填写表格。",
    },
    "inpencil": {
      focusWord: "in pencil",
      sentence: "Write your first draft in pencil.",
      chinese: "in pencil = 用铅笔；用铅笔写初稿。",
    },
    "inside": {
      focusWord: "inside",
      sentence: "It was warm inside the cafe.",
      chinese: "inside = 在里面；咖啡馆里面很暖和。",
    },
    "instead": {
      focusWord: "instead",
      sentence: "The bus was full, so we walked instead.",
      chinese: "instead = 改为；公交车满了，所以我们改为步行。",
    },
    "intheend": {
      focusWord: "in the end",
      sentence: "In the end, we chose the smaller hotel.",
      chinese: "in the end = 最后；最后，我们选择了较小的酒店。",
    },
    "into": {
      focusWord: "into",
      sentence: "She put the books into her bag.",
      chinese: "into = 进入；她把书放进了包里。",
    },
    "it": {
      focusWord: "it",
    ...
    "its": {
      ...
      chinese: "its = 它的；那只狗高兴地摇着尾巴。",
    },
    "itself": {
      focusWord: "itself",
      sentence: "The door closed by itself.",
      chinese: "itself = 它自己；门自己关上了。",
    },
    "just": {
      focusWord: "just",
      sentence: "I have just finished my homework.",
      chinese: "just = 刚刚；我刚刚完成家庭作业。",
    },
    "lately": {
      focusWord: "lately",
      sentence: "Have you seen Maya lately?",
      chinese: "lately = 最近；你最近见过玛雅吗？",
    },
    "less": {
      focusWord: "less",
      sentence: "This bag costs less than the other one.",
      chinese: "less = 更少；这个包比另一个便宜。",
    },
    "loudly": {
      focusWord: "loudly",
      sentence: "The audience cheered loudly after the song.",
      chinese: "loudly = 大声地；歌曲结束后，观众大声欢呼。",
    },
    "luckily": {
      focusWord: "luckily",
      sentence: "Luckily, we caught the last bus.",
      chinese: "luckily = 幸运地；幸运的是，我们赶上了末班公交车。",
    },
    "mainly": {
      focusWord: "mainly",
      sentence: "The course is mainly for beginners.",
      chinese: "mainly = 主要地；这门课程主要面向初学者。",
    },
    "many": {
      focusWord: "many",
      sentence: "Many people visit the castle each year.",
      chinese: "many = 许多；每年有许多人参观这座城堡。",
    },
    "may": {
      focusWord: "may",
      sentence: "You may leave when you finish the test.",
      chinese: "may = 可以；完成考试后你可以离开。",
    },
    "maybe": {
      focusWord: "maybe",
      sentence: "Maybe we can meet after lunch.",
      chinese: "maybe = 也许；也许我们可以午饭后见面。",
    },
    "me": {
      focusWord: "me",
      sentence: "Could you help me carry this box?",
      chinese: "me = 我；你能帮我搬这个箱子吗？",
    },
    "meanwhile": {
      focusWord: "meanwhile",
      sentence: "Dad cooked dinner; meanwhile, I set the table.",
      chinese: "meanwhile = 同时；爸爸做晚饭，同时我摆餐具。",
    },
    "might": {
      focusWord: "might",
      sentence: "It might rain this afternoon.",
      chinese: "might = 可能；今天下午可能会下雨。",
    },
    "mine": {
      focusWord: "mine",
      sentence: "The seat by the window is mine.",
      chinese: "mine = 我的；窗边的座位是我的。",
    },
    "minus": {
      focusWord: "minus",
      sentence: "Ten minus three equals seven.",
      chinese: "minus = 减；十减三等于七。",
    },
    "more": {
      focusWord: "more",
      sentence: "We need more chairs for the meeting.",
      chinese: "more = 更多；会议需要更多椅子。",
    },
    "most": {
      focusWord: "most",
      sentence: "Most students walk to school.",
      chinese: "most = 大多数；大多数学生步行去学校。",
    },
    "mostly": {
      focusWord: "mostly",
      sentence: "The audience was mostly teenagers.",
      chinese: "mostly = 大多；观众大多是青少年。",
    },
    "much": {
      focusWord: "much",
      sentence: "How much water should I add?",
      chinese: "much = 多少；我应该加多少水？",
    },
    "must": {
      focusWord: "must",
      sentence: "You must wear a helmet when cycling.",
      chinese: "must = 必须；骑自行车时必须戴头盔。",
    },
    "my": {
      focusWord: "my",
      sentence: "My sister lives in London.",
      chinese: "my = 我的；我姐姐住在伦敦。",
    },
    "myself": {
      focusWord: "myself",
      sentence: "I made this card myself.",
      chinese: "myself = 我亲自；这张卡片是我亲自做的。",
    },
    "near": {
      focusWord: "near",
      sentence: "Our hotel is near the station.",
      chinese: "near = 在附近；我们的酒店在车站附近。",
    },
    "nearly": {
      focusWord: "nearly",
      sentence: "It is nearly time for lunch.",
      chinese: "nearly = 几乎；快到午饭时间了。",
    },
    "neither": {
      focusWord: "neither",
      sentence: "Neither answer is correct.",
      chinese: "neither = 两个都不；两个答案都不正确。",
    },
    "never": {
      focusWord: "never",
      sentence: "I have never tried skiing.",
      chinese: "never = 从未；我从未尝试过滑雪。",
    },
    "nextto": {
      focusWord: "next to",
      sentence: "The pharmacy is next to the bank.",
      chinese: "next to = 在...旁边；药店在银行旁边。",
    },
    "no": {
      focusWord: "no",
      sentence: "There is no milk left in the fridge.",
      chinese: "no = 没有；冰箱里没有牛奶了。",
    },
    "nobody": {
      focusWord: "nobody",
      sentence: "Nobody knew the answer.",
      chinese: "nobody = 没有人；没有人知道答案。",
    },
    "none": {
      focusWord: "none",
      sentence: "None of these keys opens the door.",
      chinese: "none = 一个也没有；这些钥匙一个也打不开门。",
    },
    "normally": {
      focusWord: "normally",
      sentence: "I normally get home before six.",
      chinese: "normally = 通常；我通常六点前到家。",
    },
    "not": {
      focusWord: "not",
      sentence: "This seat is not available.",
      chinese: "not = 不；这个座位不能使用。",
    },
    "nothing": {
      focusWord: "nothing",
      sentence: "There is nothing in the box.",
      chinese: "nothing = 什么都没有；盒子里什么都没有。",
    },
    "now": {
      focusWord: "now",
      sentence: "I am busy now.",
      chinese: "now = 现在；我现在很忙。",
    },
    "nowadays": {
      focusWord: "nowadays",
      sentence: "Nowadays, many people work from home.",
      chinese: "nowadays = 如今；如今许多人在家工作。",
    },
    "nowhere": {
      focusWord: "nowhere",
      sentence: "We had nowhere to sit.",
      chinese: "nowhere = 没有地方；我们没有地方坐。",
    },
    "obviously": {
      focusWord: "obviously",
      sentence: "Obviously, you need a ticket to enter.",
      chinese: "obviously = 显然；显然，你需要门票才能进入。",
    },
    "occasionally": {
      focusWord: "occasionally",
      sentence: "We occasionally eat at that restaurant.",
      chinese: "occasionally = 偶尔；我们偶尔在那家餐馆吃饭。",
    },
    "oclock": {
      focusWord: "o'clock",
      sentence: "The lesson starts at eight o'clock.",
      chinese: "o'clock = 点钟；课程八点开始。",
    },
    "of": {
      focusWord: "of",
    ...
    "often": {
      focusWord: "often",
      sentence: "We often play tennis after school.",
      chinese: "often = 经常；我们经常放学后打网球。",
    },
    "oh": {
      focusWord: "oh",
      sentence: "Oh, I forgot my keys!",
      chinese: "oh = 哦；哦，我忘带钥匙了！",
    },
    "ohdear": {
      focusWord: "oh dear",
      sentence: "Oh dear, we have missed the last train.",
      chinese: "oh dear = 哎呀；哎呀，我们错过末班火车了。",
    },
    "on": {
      focusWord: "on",
      sentence: "The book is on the table.",
      chinese: "on = 在...上；书在桌子上。",
    },
    "onboard": {
      focusWord: "on board",
      sentence: "All the passengers are now on board.",
      chinese: "on board = 在车船飞机上；所有乘客现在都已登乘。",
    },
    "once": {
      focusWord: "once",
      sentence: "I go swimming once a week.",
      chinese: "once = 一次；我每周游泳一次。",
    },
    "one": {
      focusWord: "one",
      sentence: "I need one more ticket.",
      chinese: "one = 一个；我还需要一张票。",
    },
    "onfire": {
      focusWord: "on fire",
      sentence: "The old building was on fire.",
      chinese: "on fire = 着火；那栋旧楼着火了。",
    },
    "only": {
      focusWord: "only",
      sentence: "Only members can use the gym.",
      chinese: "only = 只有；只有会员可以使用健身房。",
    },
    "onpurpose": {
      focusWord: "on purpose",
      sentence: "He broke the cup on purpose.",
      chinese: "on purpose = 故意；他故意打破了杯子。",
    },
    "onrequest": {
      focusWord: "on request",
      sentence: "Extra towels are available on request.",
      chinese: "on request = 应要求；如有需要可以提供额外毛巾。",
    },
    "onto": {
      focusWord: "onto",
      sentence: "The cat jumped onto the table.",
      chinese: "onto = 到...上；猫跳到了桌子上。",
    },
    "or": {
      focusWord: "or",
      sentence: "Would you like tea or coffee?",
      chinese: "or = 或者；你想要茶还是咖啡？",
    },
    "other": {
      focusWord: "other",
      sentence: "Where is the other shoe?",
      chinese: "other = 另一个；另一只鞋在哪里？",
    },
    "otherwise": {
      focusWord: "otherwise",
      sentence: "Leave now, otherwise you will miss the bus.",
      chinese: "otherwise = 否则；现在就走，否则你会错过公交车。",
    },
    "ought": {
      focusWord: "ought",
      sentence: "You ought to apologise to her.",
      chinese: "ought = 应该；你应该向她道歉。",
    },
    "our": {
      focusWord: "our",
      sentence: "Our classroom is on the second floor.",
      chinese: "our = 我们的；我们的教室在二楼。",
    },
    "ours": {
      focusWord: "ours",
      sentence: "The blue tent is ours.",
      chinese: "ours = 我们的；蓝色帐篷是我们的。",
    },
    "ourselves": {
      focusWord: "ourselves",
      sentence: "We painted the room ourselves.",
      chinese: "ourselves = 我们亲自；我们亲自粉刷了房间。",
    },
    "out": {
      focusWord: "out",
      sentence: "She went out after dinner.",
      chinese: "out = 出去；她晚饭后出去了。",
    },
    "outdoors": {
      focusWord: "outdoors",
      sentence: "The children spent the afternoon outdoors.",
      chinese: "outdoors = 在户外；孩子们在户外度过了下午。",
    },
    "outof": {
      focusWord: "out of",
      sentence: "He took a notebook out of his bag.",
      chinese: "out of = 从...里面；他从包里拿出一本笔记本。",
    },
    "outofdate": {
      focusWord: "out of date",
      sentence: "This travel guide is out of date.",
      chinese: "out of date = 过时的；这本旅行指南已经过时了。",
    },
    "over": {
      focusWord: "over",
      sentence: "The lesson is over at four o'clock.",
      chinese: "over = 结束；课程四点结束。",
    },
    "own": {
      focusWord: "own",
      sentence: "I have my own room.",
      chinese: "own = 自己的；我有自己的房间。",
    },
    "pardon": {
      focusWord: "pardon",
      sentence: "Pardon me, could you repeat that?",
      chinese: "pardon = 请原谅；请原谅，你能再说一遍吗？",
    },
    "partly": {
      focusWord: "partly",
      sentence: "The path was partly covered by snow.",
      chinese: "partly = 部分地；小路部分被雪覆盖。",
    },
    "particularly": {
      focusWord: "particularly",
      sentence: "I particularly enjoyed the final song.",
      chinese: "particularly = 尤其；我尤其喜欢最后一首歌。",
    },
    "per": {
      focusWord: "per",
      sentence: "Tickets cost twelve pounds per person.",
      chinese: "per = 每；票价为每人十二英镑。",
    },
    "perfectly": {
      focusWord: "perfectly",
      sentence: "I can hear you perfectly.",
      chinese: "perfectly = 完全地；我能完全听清你说话。",
    },
    "perhaps": {
      focusWord: "perhaps",
      sentence: "Perhaps we should ask the teacher.",
      chinese: "perhaps = 也许；也许我们应该问问老师。",
    },
    "personally": {
      focusWord: "personally",
      sentence: "I personally prefer the earlier train.",
      chinese: "personally = 就个人而言；就个人而言，我更喜欢较早的火车。",
    },
    "please": {
      focusWord: "please",
    ...
    "access": {
      focusWord: "access",
      sentence: "You need a password to get access to the website.",
      chinese: "access = 访问权限；你需要密码才能访问这个网站。",
    },
    "ad": {
      focusWord: "ad",
      sentence: "I saw an ad for a new bike.",
      chinese: "ad = 广告；我看到了一则新自行车的广告。",
    },
    "advantage": {
      focusWord: "advantage",
      sentence: "Living near school is a big advantage.",
      chinese: "advantage = 优势；住在学校附近是一个很大的优势。",
    },
    "adventure": {
      focusWord: "adventure",
      sentence: "Our camping trip was a real adventure.",
      chinese: "adventure = 冒险；我们的露营旅行真是一次冒险。",
    },
    "aim": {
      focusWord: "aim",
      sentence: "My aim is to pass the exam.",
      chinese: "aim = 目标；我的目标是通过考试。",
    },
    "airforce": {
      focusWord: "air force",
      sentence: "Her brother joined the air force last year.",
      chinese: "air force = 空军；她哥哥去年加入了空军。",
    },
    "airline": {
      focusWord: "airline",
      sentence: "This airline flies to Madrid every day.",
      chinese: "airline = 航空公司；这家航空公司每天都有航班飞往马德里。",
    },
    "alarm": {
      focusWord: "alarm",
    ...
    "alarmclock": {
      ...
      sentence: "I put my alarm clock beside my bed.",
      chinese: "alarm clock = 闹钟；我把闹钟放在床边。",
    },
    "album": {
      focusWord: "album",
    ...
    "alphabet": {
      ...
      chinese: "alphabet = 字母表；孩子们在学校学习字母表。",
    },
    "ankle": {
      focusWord: "ankle",
      sentence: "He hurt his ankle during the match.",
      chinese: "ankle = 脚踝；他在比赛中伤了脚踝。",
    },
    "anniversary": {
      focusWord: "anniversary",
      sentence: "They celebrated their wedding anniversary.",
      chinese: "anniversary = 周年纪念日；他们庆祝了结婚周年纪念日。",
    },
    "answerphone": {
      focusWord: "answerphone",
      sentence: "Please leave a message on the answerphone.",
      chinese: "answerphone = 电话答录机；请在电话答录机上留言。",
    },
    "apology": {
      focusWord: "apology",
      sentence: "She wrote an apology after missing the meeting.",
      chinese: "apology = 道歉；她错过会议后写了一封道歉信。",
    },
    "apple": {
      focusWord: "apple",
      sentence: "I ate an apple after lunch.",
      chinese: "apple = 苹果；午饭后我吃了一个苹果。",
    },
    "architect": {
      focusWord: "architect",
      sentence: "The architect designed our new library.",
      chinese: "architect = 建筑师；这位建筑师设计了我们的新图书馆。",
    },
    "architecture": {
      focusWord: "architecture",
      sentence: "I love the architecture of old towns.",
      chinese: "architecture = 建筑；我喜欢古老城镇的建筑。",
    },
    "arithmetic": {
      focusWord: "arithmetic",
      sentence: "Arithmetic was my favourite maths topic.",
      chinese: "arithmetic = 算术；算术曾是我最喜欢的数学内容。",
    },
    "armchair": {
      focusWord: "armchair",
      sentence: "Grandpa reads in his armchair every evening.",
      chinese: "armchair = 扶手椅；爷爷每天晚上坐在扶手椅里读书。",
    },
    "army": {
      focusWord: "army",
      sentence: "The army helped after the flood.",
      chinese: "army = 军队；洪水过后军队提供了帮助。",
    },
    "arrival": {
      focusWord: "arrival",
      sentence: "We waited for the arrival of the train.",
      chinese: "arrival = 到达；我们等待火车到达。",
    },
    "aspirin": {
      focusWord: "aspirin",
      sentence: "The nurse gave me an aspirin for my headache.",
      chinese: "aspirin = 阿司匹林；护士给了我一片阿司匹林治头痛。",
    },
    "astronaut": {
      focusWord: "astronaut",
      sentence: "The astronaut spoke to students from space.",
      chinese: "astronaut = 宇航员；宇航员从太空和学生们讲话。",
    },
    "atsymbol": {
      focusWord: "at sign",
    ...
    "atmosphere": {
      focusWord: "atmosphere",
      sentence: "The cafe has a friendly atmosphere.",
      chinese: "atmosphere = 气氛；这家咖啡馆气氛友好。",
    },
    "attack": {
      focusWord: "attack",
      sentence: "The team started a strong attack.",
      chinese: "attack = 进攻；球队发动了一次强有力的进攻。",
    },
    "attitude": {
      focusWord: "attitude",
      sentence: "A positive attitude helps you learn.",
      chinese: "attitude = 态度；积极的态度有助于学习。",
    },
    "author": {
      focusWord: "author",
      sentence: "The author signed my book.",
      chinese: "author = 作者；作者在我的书上签了名。",
    },
    "autumn": {
      focusWord: "autumn",
      sentence: "The leaves turn yellow in autumn.",
      chinese: "autumn = 秋天；秋天树叶会变黄。",
    },
    "babysitter": {
      focusWord: "babysitter",
      sentence: "The babysitter looked after the twins.",
      chinese: "babysitter = 临时保姆；临时保姆照看那对双胞胎。",
    },
    "backpack": {
      focusWord: "backpack",
      sentence: "Put your lunch in your backpack.",
      chinese: "backpack = 背包；把午餐放进你的背包里。",
    },
    "backpacker": {
      focusWord: "backpacker",
      sentence: "The backpacker stayed in a cheap hostel.",
      chinese: "backpacker = 背包客；那位背包客住在一家便宜的旅舍。",
    },
    "backpacking": {
      focusWord: "backpacking",
      sentence: "Backpacking across Europe was exciting.",
      chinese: "backpacking = 背包旅行；在欧洲背包旅行很令人兴奋。",
    },
    "badminton": {
      focusWord: "badminton",
      sentence: "We play badminton after school.",
      chinese: "badminton = 羽毛球；我们放学后打羽毛球。",
    },
    "bag": {
      focusWord: "bag",
      sentence: "She packed a bag for the weekend.",
      chinese: "bag = 包；她为周末收拾了一个包。",
    },
    "baggage": {
      focusWord: "baggage",
      sentence: "Our baggage arrived late at the airport.",
      chinese: "baggage = 行李；我们的行李在机场晚到了。",
    },
    "baker": {
      focusWord: "baker",
      sentence: "The baker sells fresh bread every morning.",
      chinese: "baker = 面包师；面包师每天早晨卖新鲜面包。",
    },
    "balcony": {
      focusWord: "balcony",
      sentence: "We had breakfast on the balcony.",
      chinese: "balcony = 阳台；我们在阳台上吃了早饭。",
    },
    "ball": {
      focusWord: "ball",
      sentence: "The ball rolled under the car.",
      chinese: "ball = 球；球滚到了汽车下面。",
    },
    "ballet": {
      focusWord: "ballet",
      sentence: "She goes to ballet class on Fridays.",
      chinese: "ballet = 芭蕾舞；她星期五去上芭蕾舞课。",
    },
    "balloon": {
      focusWord: "balloon",
      sentence: "The red balloon flew into the sky.",
      chinese: "balloon = 气球；红色气球飞上了天空。",
    },
    "banana": {
      focusWord: "banana",
      sentence: "He put a banana in his lunch box.",
      chinese: "banana = 香蕉；他把一根香蕉放进午餐盒。",
    },
    "band": {
      focusWord: "band",
      sentence: "The school band played at the concert.",
      chinese: "band = 乐队；学校乐队在音乐会上演奏。",
    },
    "bandage": {
      focusWord: "bandage",
      sentence: "The nurse put a bandage on my knee.",
      chinese: "bandage = 绷带；护士在我的膝盖上缠了绷带。",
    },
    "banker": {
      focusWord: "banker",
      sentence: "The banker explained the loan carefully.",
      chinese: "banker = 银行家；银行家仔细解释了贷款。",
    },
    "banking": {
      focusWord: "banking",
      sentence: "Online banking makes it easy to pay bills.",
      chinese: "banking = 银行业务；网上银行业务让付账更容易。",
    },
    "bar": {
      focusWord: "bar",
      sentence: "We met at a small bar near the station.",
      chinese: "bar = 酒吧；我们在车站附近的一家小酒吧见面。",
    },
    "barbecue": {
      focusWord: "barbecue",
      sentence: "We had a barbecue in the garden.",
      chinese: "barbecue = 烧烤；我们在花园里吃了烧烤。",
    },
    "barber": {
      focusWord: "barber",
      sentence: "The barber cut my hair before the party.",
      chinese: "barber = 理发师；聚会前理发师给我剪了头发。",
    },
    "bargain": {
      focusWord: "bargain",
      sentence: "This jacket was a real bargain in the sale.",
      chinese: "bargain = 便宜货；这件夹克在促销中真是便宜货。",
    },
    "basin": {
      focusWord: "basin",
      sentence: "Wash your hands in the basin.",
      chinese: "basin = 洗手盆；在洗手盆里洗手。",
    },
    "basket": {
      focusWord: "basket",
      sentence: "She carried the apples in a basket.",
      chinese: "basket = 篮子；她用篮子装苹果。",
    },
    "bat": {
      focusWord: "bat",
      sentence: "He hit the ball with a bat.",
      chinese: "bat = 球棒；他用球棒击球。",
    },
    "bathingsuit": {
      focusWord: "bathing suit",
      sentence: "Pack your bathing suit for the beach.",
      chinese: "bathing suit = 泳衣；去海滩时带上你的泳衣。",
    },
    "bathtub": {
      focusWord: "bathtub",
      sentence: "The bathtub was full of warm water.",
      chinese: "bathtub = 浴缸；浴缸里装满了温水。",
    },
    "battery": {
      focusWord: "battery",
      sentence: "The camera needs a new battery.",
      chinese: "battery = 电池；这台相机需要一块新电池。",
    },
    "battle": {
      focusWord: "battle",
      sentence: "The battle lasted all night.",
      chinese: "battle = 战斗；这场战斗持续了一整夜。",
    },
    "bay": {
      focusWord: "bay",
      sentence: "The hotel looks over the bay.",
      chinese: "bay = 海湾；这家酒店俯瞰海湾。",
    },
    "beard": {
      focusWord: "beard",
      sentence: "My uncle has a short beard.",
      chinese: "beard = 胡子；我叔叔留着短胡子。",
    },
    "beauty": {
      focusWord: "beauty",
      sentence: "We enjoyed the beauty of the mountains.",
      chinese: "beauty = 美；我们欣赏了群山的美。",
    },
    "beef": {
      focusWord: "beef",
      sentence: "I ordered beef with rice.",
      chinese: "beef = 牛肉；我点了牛肉配米饭。",
    },
    "beginner": {
      focusWord: "beginner",
      sentence: "This course is good for a beginner.",
      chinese: "beginner = 初学者；这门课适合初学者。",
    },
    "beginning": {
      focusWord: "beginning",
      sentence: "The beginning of the film was funny.",
      chinese: "beginning = 开头；这部电影的开头很有趣。",
    },
    "behaviour": {
      focusWord: "behaviour",
      sentence: "His behaviour in class was excellent.",
      chinese: "behaviour = 行为；他在课堂上的行为很棒。",
    },
    "bell": {
      focusWord: "bell",
      sentence: "The school bell rang at nine.",
      chinese: "bell = 铃；学校铃声在九点响了。",
    },
    "belt": {
      focusWord: "belt",
      sentence: "He wears a black belt with his jeans.",
      chinese: "belt = 腰带；他穿牛仔裤时系一条黑色腰带。",
    },
    "benefit": {
      focusWord: "benefit",
      sentence: "One benefit of cycling is fresh air.",
      chinese: "benefit = 好处；骑自行车的一个好处是能呼吸新鲜空气。",
    },
    "bestseller": {
      focusWord: "bestseller",
      sentence: "Her first book became a bestseller.",
      chinese: "bestseller = 畅销书；她的第一本书成了畅销书。",
    },
    "bin": {
      focusWord: "bin",
      sentence: "Put the paper in the recycling bin.",
      chinese: "bin = 垃圾桶；把纸放进回收垃圾桶。",
    },
    "biography": {
      focusWord: "biography",
      sentence: "I read a biography of a famous singer.",
      chinese: "biography = 传记；我读了一本著名歌手的传记。",
    },
    "biology": {
      focusWord: "biology",
      sentence: "Biology teaches us about plants and animals.",
      chinese: "biology = 生物学；生物学教我们了解植物和动物。",
    },
    "birth": {
      focusWord: "birth",
      sentence: "The birth of the baby made everyone happy.",
      chinese: "birth = 出生；宝宝的出生让大家都很高兴。",
    },
    "biscuit": {
      focusWord: "biscuit",
      sentence: "Would you like a biscuit with your tea?",
      chinese: "biscuit = 饼干；你想喝茶时吃块饼干吗？",
    },
    "bit": {
      focusWord: "bit",
      sentence: "I need a bit of help with this bag.",
      chinese: "bit = 一点；这个包我需要一点帮助。",
    },
    "blackboard": {
      focusWord: "blackboard",
      sentence: "The teacher wrote the date on the blackboard.",
      chinese: "blackboard = 黑板；老师把日期写在黑板上。",
    },
    "block": {
      focusWord: "block",
      sentence: "He put a block of wood under the door.",
      chinese: "block = 块；他把一块木头放在门下面。",
    },
    "blog": {
      focusWord: "blog",
      sentence: "She writes a travel blog.",
      chinese: "blog = 博客；她写一个旅行博客。",
    },
    "blogger": {
      focusWord: "blogger",
      sentence: "The blogger shared photos of the city.",
      chinese: "blogger = 博主；这位博主分享了这座城市的照片。",
    },
    "blouse": {
      focusWord: "blouse",
      sentence: "She wore a blue blouse to work.",
      chinese: "blouse = 女衬衫；她穿了一件蓝色女衬衫去上班。",
    },
    "board": {
      focusWord: "board",
      sentence: "Write your answers on the board.",
      chinese: "board = 板；把你的答案写在板上。",
    },
    "boardingpass": {
      focusWord: "boarding pass",
      sentence: "Show your boarding pass at the gate.",
      chinese: "boarding pass = 登机牌；在登机口出示你的登机牌。",
    },
    "bomb": {
      focusWord: "bomb",
      sentence: "The old bomb was removed safely.",
      chinese: "bomb = 炸弹；那枚旧炸弹被安全移走了。",
    },
    "bone": {
      focusWord: "bone",
      sentence: "The dog found a bone in the garden.",
      chinese: "bone = 骨头；狗在花园里找到了一根骨头。",
    },
    "booking": {
      focusWord: "booking",
      sentence: "I made a booking for two rooms.",
      chinese: "booking = 预订；我预订了两个房间。",
    },
    "bookshop": {
      focusWord: "bookshop",
      sentence: "I bought a novel at the bookshop.",
      chinese: "bookshop = 书店；我在书店买了一本小说。",
    },
    "bookstore": {
      focusWord: "bookstore",
      sentence: "The bookstore closes at eight.",
      chinese: "bookstore = 书店；这家书店八点关门。",
    },
    "border": {
      focusWord: "border",
      sentence: "The river forms the border between the two countries.",
      chinese: "border = 边界；这条河形成了两国之间的边界。",
    },
    "boss": {
      focusWord: "boss",
      sentence: "My boss approved the plan.",
      chinese: "boss = 老板；我的老板批准了这个计划。",
    },
    "box": {
      focusWord: "box",
      sentence: "Put the toys in the box.",
      chinese: "box = 盒子；把玩具放进盒子里。",
    },
    "boxing": {
      focusWord: "boxing",
      sentence: "Boxing is popular at the sports centre.",
      chinese: "boxing = 拳击；拳击在体育中心很受欢迎。",
    },
    "boyfriend": {
      focusWord: "boyfriend",
      sentence: "Her boyfriend is studying music.",
      chinese: "boyfriend = 男朋友；她的男朋友正在学习音乐。",
    },
    "brain": {
      focusWord: "brain",
      sentence: "Your brain needs rest after a long exam.",
      chinese: "brain = 大脑；长时间考试后你的大脑需要休息。",
    },
    "brake": {
      focusWord: "brake",
      sentence: "The bike brake needs fixing.",
      chinese: "brake = 刹车；这辆自行车的刹车需要修理。",
    },
    "branch": {
      focusWord: "branch",
      sentence: "A branch fell from the tree.",
      chinese: "branch = 树枝；一根树枝从树上掉了下来。",
    },
    "breath": {
      focusWord: "breath",
      sentence: "Take a deep breath before you speak.",
      chinese: "breath = 呼吸；说话前深呼吸。",
    },
    "breeze": {
      focusWord: "breeze",
      sentence: "A cool breeze came through the window.",
      chinese: "breeze = 微风；一阵凉爽的微风从窗户吹进来。",
    },
    "bride": {
      focusWord: "bride",
      sentence: "The bride smiled during the ceremony.",
      chinese: "bride = 新娘；新娘在仪式上微笑。",
    },
    "bridge": {
      focusWord: "bridge",
      sentence: "We crossed the old bridge on foot.",
      chinese: "bridge = 桥；我们步行穿过了那座老桥。",
    },
    "broccoli": {
      focusWord: "broccoli",
      sentence: "Broccoli is my sister's favourite vegetable.",
      chinese: "broccoli = 西兰花；西兰花是我妹妹最喜欢的蔬菜。",
    },
    "brochure": {
      focusWord: "brochure",
      sentence: "Pick up a brochure at the tourist office.",
      chinese: "brochure = 小册子；在旅游办公室拿一本小册子。",
    },
    "brush": {
      focusWord: "brush",
      sentence: "Use this brush to clean your shoes.",
      chinese: "brush = 刷子；用这把刷子清洁你的鞋。",
    },
    "bucket": {
      focusWord: "bucket",
      sentence: "Fill the bucket with water.",
      chinese: "bucket = 桶；把桶装满水。",
    },
    "bug": {
      focusWord: "bug",
      sentence: "The computer game has a small bug.",
      chinese: "bug = 程序错误；这个电脑游戏有一个小程序错误。",
    },
    "bulb": {
      focusWord: "bulb",
      sentence: "We need a new bulb for the lamp.",
      chinese: "bulb = 灯泡；这盏灯需要一个新灯泡。",
    },
    "bull": {
      focusWord: "bull",
      sentence: "The bull stood in the field.",
      chinese: "bull = 公牛；那头公牛站在田里。",
    },
    "bunch": {
      focusWord: "bunch",
      sentence: "She bought a bunch of flowers.",
      chinese: "bunch = 一束；她买了一束花。",
    },
    "bush": {
      focusWord: "bush",
      sentence: "A small bush grew beside the path.",
      chinese: "bush = 灌木；小路旁长着一丛小灌木。",
    },
    "butcher": {
      focusWord: "butcher",
    ...
    "butter": {
      focusWord: "butter",
      sentence: "Spread some butter on the bread.",
      chinese: "butter = 黄油；在面包上抹些黄油。",
    },
    "butterfly": {
      focusWord: "butterfly",
      sentence: "A butterfly landed on the flower.",
      chinese: "butterfly = 蝴蝶；一只蝴蝶落在花上。",
    },
    "button": {
      focusWord: "button",
      sentence: "Press the red button to start.",
      chinese: "button = 按钮；按红色按钮开始。",
    },
    "buyer": {
      focusWord: "buyer",
      sentence: "The buyer asked about the price.",
      chinese: "buyer = 买家；买家询问了价格。",
    },
    "cab": {
      focusWord: "cab",
      sentence: "We took a cab to the station.",
      chinese: "cab = 出租车；我们乘出租车去了车站。",
    },
    "cabbage": {
      focusWord: "cabbage",
      sentence: "Add the cabbage to the soup.",
      chinese: "cabbage = 卷心菜；把卷心菜加进汤里。",
    },
    "cabin": {
      focusWord: "cabin",
      sentence: "We stayed in a small cabin by the lake.",
      chinese: "cabin = 小木屋；我们住在湖边的一间小木屋里。",
    },
    "cabinet": {
      focusWord: "cabinet",
      sentence: "The plates are in the kitchen cabinet.",
      chinese: "cabinet = 橱柜；盘子在厨房橱柜里。",
    },
    "cable": {
      focusWord: "cable",
      sentence: "The cable connects the screen to the computer.",
      chinese: "cable = 电缆；这根电缆把屏幕连接到电脑上。",
    },
    "cafe": {
      focusWord: "cafe",
      sentence: "Let's meet at the cafe after school.",
      chinese: "cafe = 咖啡馆；我们放学后在咖啡馆见面吧。",
    },
    "cafeteria": {
      focusWord: "cafeteria",
      sentence: "Students eat lunch in the cafeteria.",
      chinese: "cafeteria = 自助餐厅；学生们在自助餐厅吃午饭。",
    },
    "calf": {
      focusWord: "calf",
      sentence: "The young calf stayed close to its mother.",
      chinese: "calf = 小牛；小牛紧挨着它的妈妈。",
    },
    "camel": {
      focusWord: "camel",
      sentence: "A camel can carry heavy bags in the desert.",
      chinese: "camel = 骆驼；骆驼能在沙漠里驮重包。",
    },
    "camp": {
      focusWord: "camp",
      sentence: "The summer camp starts in July.",
      chinese: "camp = 营地；夏令营在七月开始。",
    },
    "campsite": {
      focusWord: "campsite",
      sentence: "Our campsite was near the river.",
      chinese: "campsite = 露营地；我们的露营地在河边。",
    },
    "canal": {
      focusWord: "canal",
      sentence: "We walked along the canal in the evening.",
      chinese: "canal = 运河；晚上我们沿着运河散步。",
    },
    "candidate": {
      focusWord: "candidate",
      sentence: "Each candidate gave a short speech.",
      chinese: "candidate = 候选人；每位候选人都做了简短演讲。",
    },
    "candle": {
      focusWord: "candle",
      sentence: "She lit a candle during the power cut.",
      chinese: "candle = 蜡烛；停电时她点了一支蜡烛。",
    },
    "candy": {
      focusWord: "candy",
      sentence: "The children shared a bag of candy.",
      chinese: "candy = 糖果；孩子们分享了一袋糖果。",
    },
    "canteen": {
      focusWord: "canteen",
      sentence: "The canteen sells hot meals at lunchtime.",
      chinese: "canteen = 食堂；食堂午餐时间卖热饭。",
    },
    "captain": {
      focusWord: "captain",
      sentence: "The captain thanked the team after the match.",
      chinese: "captain = 队长；比赛后队长感谢了全队。",
    },
    "care": {
      focusWord: "care",
      sentence: "The old house needs a lot of care.",
      chinese: "care = 照料；这座老房子需要大量照料。",
    },
    "carrot": {
      focusWord: "carrot",
      sentence: "Cut the carrot into small pieces.",
      chinese: "carrot = 胡萝卜；把胡萝卜切成小块。",
    },
    "cartoon": {
      focusWord: "cartoon",
    ...
    "cashpoint": {
      focusWord: "cashpoint",
      sentence: "There is a cashpoint outside the bank.",
      chinese: "cashpoint = 自动取款机；银行外面有一台自动取款机。",
    },
    "castle": {
      focusWord: "castle",
      sentence: "The castle is on top of the hill.",
      chinese: "castle = 城堡；城堡在山顶上。",
    },
    "cathedral": {
      focusWord: "cathedral",
      sentence: "The cathedral has beautiful windows.",
      chinese: "cathedral = 大教堂；这座大教堂有美丽的窗户。",
    },
    "cattle": {
      focusWord: "cattle",
      sentence: "The farmer keeps cattle on the farm.",
      chinese: "cattle = 牛群；农民在农场养牛群。",
    },
    "cave": {
      focusWord: "cave",
      sentence: "We explored a dark cave near the beach.",
      chinese: "cave = 洞穴；我们探索了海滩附近的一个黑暗洞穴。",
    },
    "ceiling": {
      focusWord: "ceiling",
      sentence: "The lamp hangs from the ceiling.",
      chinese: "ceiling = 天花板；灯从天花板上垂下来。",
    },
    "centimetre": {
      focusWord: "centimetre",
      sentence: "The pencil is one centimetre longer than mine.",
      chinese: "centimetre = 厘米；这支铅笔比我的长一厘米。",
    },
    "centralheating": {
      focusWord: "central heating",
      sentence: "The central heating keeps the house warm.",
      chinese: "central heating = 中央供暖；中央供暖让房子保持温暖。",
    },
    "century": {
      focusWord: "century",
      sentence: "This bridge was built last century.",
      chinese: "century = 世纪；这座桥建于上个世纪。",
    },
    "cereal": {
      focusWord: "cereal",
    ...
    "certificate": {
      ...
      sentence: "She received a certificate for the course.",
      chinese: "certificate = 证书；她获得了这门课程的证书。",
    },
    "chain": {
      focusWord: "chain",
      sentence: "He locked the bike with a chain.",
      chinese: "chain = 链条；他用链条锁住自行车。",
    },
    "challenge": {
      focusWord: "challenge",
      sentence: "Climbing the hill was a real challenge.",
      chinese: "challenge = 挑战；爬这座山真是一次挑战。",
    },
    "champion": {
      focusWord: "champion",
      sentence: "The champion held up the gold cup.",
      chinese: "champion = 冠军；冠军举起了金杯。",
    },
    "channel": {
      focusWord: "channel",
      sentence: "Change the channel if the film is boring.",
      chinese: "channel = 频道；如果电影无聊就换个频道。",
    },
    "charge": {
      focusWord: "charge",
      sentence: "There is no charge for museum entry.",
      chinese: "charge = 费用；博物馆入场不收费。",
    },
    "chat": {
      focusWord: "chat",
      sentence: "We had a short chat after class.",
      chinese: "chat = 聊天；课后我们简短地聊了一会儿。",
    },
    "chatroom": {
      focusWord: "chatroom",
      sentence: "The teacher opened a safe chatroom for the class.",
      chinese: "chatroom = 聊天室；老师为班级开了一个安全的聊天室。",
    },
    "check": {
      focusWord: "check",
      sentence: "The mechanic did a quick check of the brakes.",
      chinese: "check = 检查；机械师快速检查了刹车。",
    },
    "checkinnoun": {
      focusWord: "check-in",
    ...
    "cheek": {
      focusWord: "cheek",
      sentence: "A tear ran down her cheek.",
      chinese: "cheek = 脸颊；一滴眼泪顺着她的脸颊流下。",
    },
    "chemist": {
      focusWord: "chemist",
      sentence: "The chemist tested the water in the lab.",
      chinese: "chemist = 化学家；化学家在实验室检测了水。",
    },
    "chemistry": {
      focusWord: "chemistry",
      sentence: "Chemistry is difficult but interesting.",
      chinese: "chemistry = 化学；化学很难但很有趣。",
    },
    "chess": {
      focusWord: "chess",
      sentence: "We played chess during the break.",
      chinese: "chess = 国际象棋；休息时我们下了国际象棋。",
    },
    "chestofdrawers": {
      focusWord: "chest of drawers",
      sentence: "Put your socks in the chest of drawers.",
      chinese: "chest of drawers = 五斗柜；把你的袜子放进五斗柜里。",
    },
    "childhood": {
      focusWord: "childhood",
      sentence: "She spent her childhood near the sea.",
      chinese: "childhood = 童年；她在海边度过了童年。",
    },
    "chilli": {
      focusWord: "chilli",
      sentence: "This chilli is too hot for me.",
      chinese: "chilli = 辣椒；这个辣椒对我来说太辣了。",
    },
    "chin": {
      focusWord: "chin",
      sentence: "He cut his chin when he fell.",
      chinese: "chin = 下巴；他摔倒时划伤了下巴。",
    },
    "chip": {
      focusWord: "chip",
      sentence: "She ate one potato chip before dinner.",
      chinese: "chip = 薯片；晚饭前她吃了一片薯片。",
    },
    "chocolate": {
      focusWord: "chocolate",
      sentence: "I bought a bar of chocolate.",
      chinese: "chocolate = 巧克力；我买了一块巧克力。",
    },
    "circus": {
      focusWord: "circus",
      sentence: "The circus came to town in spring.",
      chinese: "circus = 马戏团；春天马戏团来到了镇上。",
    },
    "cleaner": {
      focusWord: "cleaner",
      sentence: "The cleaner washed the classroom floor.",
      chinese: "cleaner = 清洁工；清洁工清洗了教室地板。",
    },
    "click": {
      focusWord: "click",
    ...
    "cliff": {
      focusWord: "cliff",
      sentence: "The path goes along the top of the cliff.",
      chinese: "cliff = 悬崖；这条小路沿着悬崖顶延伸。",
    },
    "climbing": {
      focusWord: "climbing",
      sentence: "Climbing is safer with a teacher.",
      chinese: "climbing = 攀岩；有老师指导时攀岩更安全。",
    },
    "clock": {
      focusWord: "clock",
      sentence: "The clock on the wall is slow.",
      chinese: "clock = 时钟；墙上的时钟慢了。",
    },
    "clown": {
      focusWord: "clown",
      sentence: "The clown made the children laugh.",
      chinese: "clown = 小丑；小丑逗孩子们笑了。",
    },
    "coast": {
      focusWord: "coast",
      sentence: "We drove along the coast at sunset.",
      chinese: "coast = 海岸；日落时我们沿着海岸开车。",
    },
    "coconut": {
      focusWord: "coconut",
      sentence: "She drank juice from a coconut.",
      chinese: "coconut = 椰子；她喝了椰子里的汁。",
    },
    "cod": {
      focusWord: "cod",
      sentence: "Cod is often served with chips.",
      chinese: "cod = 鳕鱼；鳕鱼常和薯条一起上桌。",
    },
    "cola": {
      focusWord: "cola",
      sentence: "He ordered a cola with his meal.",
      chinese: "cola = 可乐；他点餐时要了一杯可乐。",
    },
    "collar": {
      focusWord: "collar",
      sentence: "The shirt has a white collar.",
      chinese: "collar = 衣领；这件衬衫有白色衣领。",
    },
    "colleague": {
      focusWord: "colleague",
      sentence: "My colleague helped me finish the report.",
      chinese: "colleague = 同事；我的同事帮我完成了报告。",
    },
    "colour": {
      focusWord: "colour",
      sentence: "Blue is my favourite colour.",
      chinese: "colour = 颜色；蓝色是我最喜欢的颜色。",
    },
    "comb": {
      focusWord: "comb",
      sentence: "I keep a comb in my bag.",
      chinese: "comb = 梳子；我包里放着一把梳子。",
    },
    "comedy": {
      focusWord: "comedy",
      sentence: "We watched a comedy on Friday night.",
      chinese: "comedy = 喜剧；星期五晚上我们看了一部喜剧。",
    },
    "comfort": {
      focusWord: "comfort",
    ...
    "comma": {
      focusWord: "comma",
      sentence: "Put a comma after the first word.",
      chinese: "comma = 逗号；在第一个词后面加一个逗号。",
    },
    "competitor": {
    ...
    "complaint": {
      focusWord: "complaint",
      sentence: "The hotel received a complaint about the noise.",
      chinese: "complaint = 投诉；酒店收到了一起关于噪音的投诉。",
    },
    "conclusion": {
      focusWord: "conclusion",
      sentence: "Write a short conclusion at the end.",
      chinese: "conclusion = 结论；在结尾写一个简短结论。",
    },
    "consonant": {
      focusWord: "consonant",
      sentence: "The letter b is a consonant.",
      chinese: "consonant = 辅音；字母 b 是一个辅音。",
    },
    "contact": {
      focusWord: "contact",
      sentence: "Add my email as a contact.",
      chinese: "contact = 联系人；把我的电子邮件添加为联系人。",
    },
    "contents": {
      focusWord: "contents",
      sentence: "Check the contents of the box.",
      chinese: "contents = 内容物；检查盒子里的内容物。",
    },
    "contest": {
      focusWord: "contest",
      sentence: "She won first prize in the writing contest.",
      chinese: "contest = 比赛；她在写作比赛中获得了一等奖。",
    },
    "continent": {
      focusWord: "continent",
      sentence: "Asia is the largest continent.",
      chinese: "continent = 大洲；亚洲是最大的大洲。",
    },
    "contract": {
      focusWord: "contract",
      sentence: "Read the contract before you sign it.",
      chinese: "contract = 合同；签字前先阅读合同。",
    },
    "control": {
      focusWord: "control",
      sentence: "The driver lost control of the car.",
      chinese: "control = 控制；司机失去了对汽车的控制。",
    },
    "cookery": {
      focusWord: "cookery",
      sentence: "Cookery lessons teach simple meals.",
      chinese: "cookery = 烹饪；烹饪课教授简单餐食。",
    },
    "cookie": {
      focusWord: "cookie",
      sentence: "I saved a cookie for my brother.",
      chinese: "cookie = 曲奇饼；我给弟弟留了一块曲奇饼。",
    },
    "cooking": {
      focusWord: "cooking",
      sentence: "Her cooking smells wonderful.",
      chinese: "cooking = 烹饪；她做饭的味道很香。",
    },
    "copy": {
      focusWord: "copy",
      sentence: "Please send me a copy of the form.",
      chinese: "copy = 复印件；请给我一份表格复印件。",
    },
    "corn": {
      focusWord: "corn",
      sentence: "We had corn with dinner.",
      chinese: "corn = 玉米；我们晚饭吃了玉米。",
    },
    "costume": {
      focusWord: "costume",
      sentence: "He wore a pirate costume to the party.",
      chinese: "costume = 服装；他穿着海盗服装去参加聚会。",
    },
    "cough": {
      focusWord: "cough",
    ...
    "honeymoon": {
      ...
      chinese: "honeymoon = 蜜月；他们在希腊度蜜月。",
    },
    "hoodie": {
      focusWord: "hoodie",
      sentence: "He wore a blue hoodie to school.",
      chinese: "hoodie = 连帽衫；他穿着一件蓝色连帽衫去学校。",
    },
    "housewife": {
      focusWord: "housewife",
      sentence: "The housewife planned meals for the week.",
      chinese: "housewife = 家庭主妇；这位家庭主妇计划了一周的饭菜。",
    },
    "hug": {
      focusWord: "hug",
      sentence: "She gave her brother a big hug.",
      chinese: "hug = 拥抱；她给了弟弟一个大大的拥抱。",
    },
    "humor": {
      focusWord: "humor",
      sentence: "The film has a lot of gentle humor.",
      chinese: "humor = 幽默；这部电影有许多温和的幽默。",
    },
    "hunger": {
      focusWord: "hunger",
      sentence: "Hunger made the children quiet.",
      chinese: "hunger = 饥饿；饥饿让孩子们安静下来。",
    },
    "hurry": {
      focusWord: "hurry",
      sentence: "We were in a hurry after breakfast.",
      chinese: "hurry = 匆忙；早饭后我们很匆忙。",
    },
    "hut": {
      focusWord: "hut",
      sentence: "The old hut stood near the forest.",
      chinese: "hut = 小屋；旧小屋在森林附近。",
    },
    "ice": {
      focusWord: "ice",
      sentence: "There was ice on the road this morning.",
      chinese: "ice = 冰；今天早上路上有冰。",
    },
    "iceskates": {
      focusWord: "ice skates",
      sentence: "She put on her ice skates at the rink.",
      chinese: "ice skates = 冰鞋；她在溜冰场穿上冰鞋。",
    },
    "id": {
      focusWord: "ID",
      sentence: "Show your ID at the entrance.",
      chinese: "ID = 身份证件；在入口处出示你的身份证件。",
    },
    "idea": {
      focusWord: "idea",
      sentence: "That is a good idea for the project.",
      chinese: "idea = 想法；这是这个项目的一个好想法。",
    },
    "inch": {
      focusWord: "inch",
      sentence: "The shelf is one inch too wide.",
      chinese: "inch = 英寸；这个架子宽了一英寸。",
    },
    "ingredient": {
      focusWord: "ingredient",
      sentence: "Sugar is the main ingredient in this cake.",
      chinese: "ingredient = 原料；糖是这个蛋糕的主要原料。",
    },
    "initial": {
      focusWord: "initial",
      sentence: "Write your initial at the top of the page.",
      chinese: "initial = 首字母；把你的首字母写在页面顶部。",
    },
    "ink": {
      focusWord: "ink",
      sentence: "The printer needs black ink.",
      chinese: "ink = 墨水；打印机需要黑色墨水。",
    },
    "inquiry": {
      focusWord: "inquiry",
      sentence: "The office answered my inquiry by email.",
      chinese: "inquiry = 询问；办公室通过电子邮件回答了我的询问。",
    },
    "instructor": {
      focusWord: "instructor",
      sentence: "The ski instructor helped the beginners.",
      chinese: "instructor = 教练；滑雪教练帮助了初学者。",
    },
    "interest": {
      focusWord: "interest",
      sentence: "She showed interest in photography.",
      chinese: "interest = 兴趣；她表现出对摄影的兴趣。",
    },
    "interval": {
      focusWord: "interval",
      sentence: "We bought drinks during the interval.",
      chinese: "interval = 中场休息；我们在中场休息时买了饮料。",
    },
    "interviewer": {
      focusWord: "interviewer",
      sentence: "The interviewer asked about my experience.",
      chinese: "interviewer = 面试官；面试官询问了我的经验。",
    },
    "inventor": {
      focusWord: "inventor",
      sentence: "The inventor showed us a new machine.",
      chinese: "inventor = 发明家；发明家向我们展示了一台新机器。",
    },
    "iron": {
      focusWord: "iron",
      sentence: "The iron was too hot for the shirt.",
      chinese: "iron = 熨斗；熨斗对这件衬衫来说太烫了。",
    },
    "ironing": {
      focusWord: "ironing",
      sentence: "I finished the ironing before dinner.",
      chinese: "ironing = 熨衣服；我晚饭前熨完了衣服。",
    },
    "issue": {
      focusWord: "issue",
      sentence: "The latest issue of the magazine is out.",
      chinese: "issue = 期号；这本杂志的最新一期出版了。",
    },
    "item": {
      focusWord: "item",
      sentence: "Choose one item from the menu.",
      chinese: "item = 项目；从菜单中选择一项。",
    },
    "jail": {
      focusWord: "jail",
      sentence: "The thief spent a night in jail.",
      chinese: "jail = 监狱；小偷在监狱里待了一晚。",
    },
    "jar": {
      focusWord: "jar",
      sentence: "Open the jar of strawberry jam.",
      chinese: "jar = 罐子；打开那罐草莓酱。",
    },
    "jazz": {
      focusWord: "jazz",
      sentence: "Jazz was playing in the cafe.",
      chinese: "jazz = 爵士乐；咖啡馆里播放着爵士乐。",
    },
    "jet": {
      focusWord: "jet",
      sentence: "A jet flew high above the clouds.",
      chinese: "jet = 喷气式飞机；一架喷气式飞机在云层上方高飞。",
    },
    "jewellery": {
      focusWord: "jewellery",
      sentence: "She keeps her jewellery in a small box.",
      chinese: "jewellery = 珠宝；她把珠宝放在一个小盒子里。",
    },
    "jogging": {
      focusWord: "jogging",
      sentence: "Jogging before breakfast wakes me up.",
      chinese: "jogging = 慢跑；早饭前慢跑让我清醒。",
    },
    "joke": {
      focusWord: "joke",
      sentence: "His joke made everyone laugh.",
      chinese: "joke = 笑话；他的笑话让大家都笑了。",
    },
    "judge": {
      focusWord: "judge",
      sentence: "The judge listened to both teams.",
      chinese: "judge = 裁判；裁判听取了两队的意见。",
    },
    "jug": {
      focusWord: "jug",
      sentence: "Pour the milk into the jug.",
      chinese: "jug = 壶；把牛奶倒进壶里。",
    },
    "jump": {
      focusWord: "jump",
      sentence: "The horse made a high jump.",
      chinese: "jump = 跳跃；那匹马做了一个高跳。",
    },
    "jumper": {
      focusWord: "jumper",
      sentence: "She wore a warm jumper in class.",
      chinese: "jumper = 套头毛衣；她在课堂上穿了一件暖和的套头毛衣。",
    },
    "jungle": {
      focusWord: "jungle",
      sentence: "The jungle was full of strange sounds.",
      chinese: "jungle = 丛林；丛林里充满了奇怪的声音。",
    },
    "kangaroo": {
      focusWord: "kangaroo",
      sentence: "A kangaroo crossed the road slowly.",
      chinese: "kangaroo = 袋鼠；一只袋鼠慢慢穿过马路。",
    },
    "keeper": {
      focusWord: "keeper",
      sentence: "The zoo keeper fed the lions.",
      chinese: "keeper = 饲养员；动物园饲养员喂了狮子。",
    },
    "kick": {
      focusWord: "kick",
      sentence: "His kick sent the ball into the goal.",
      chinese: "kick = 踢；他的一脚把球送进了球门。",
    },
    "kid": {
      focusWord: "kid",
      sentence: "The kid carried a red backpack.",
      chinese: "kid = 孩子；那个孩子背着一个红色背包。",
    },
    "kilogramme": {
      focusWord: "kilogramme",
      sentence: "This bag weighs one kilogramme.",
      chinese: "kilogramme = 千克；这个袋子重一千克。",
    },
    "kiss": {
      focusWord: "kiss",
      sentence: "She gave the baby a kiss.",
      chinese: "kiss = 吻；她亲了宝宝一下。",
    },
    "kit": {
      focusWord: "kit",
      sentence: "The first-aid kit is in the kitchen.",
      chinese: "kit = 工具包；急救包在厨房里。",
    },
    "kite": {
      focusWord: "kite",
      sentence: "The kite flew over the beach.",
      chinese: "kite = 风筝；风筝在海滩上空飞翔。",
    },
    "kitten": {
      focusWord: "kitten",
      sentence: "The kitten slept in a basket.",
      chinese: "kitten = 小猫；小猫睡在篮子里。",
    },
    "knowledge": {
      focusWord: "knowledge",
      sentence: "Her knowledge of history is excellent.",
      chinese: "knowledge = 知识；她的历史知识非常出色。",
    },
    "label": {
      focusWord: "label",
      sentence: "Read the label before you wash the shirt.",
      chinese: "label = 标签；洗衬衫前阅读标签。",
    },
    "laboratory": {
      focusWord: "laboratory",
    ...
    "pasta": {
      focusWord: "pasta",
      sentence: "I cooked pasta for dinner.",
      chinese: "pasta = 意大利面；我晚饭做了意大利面。",
    },
    "path": {
      focusWord: "path",
      sentence: "Follow the path through the park.",
      chinese: "path = 小路；沿着小路穿过公园。",
    },
    "pattern": {
      focusWord: "pattern",
      sentence: "This shirt has a flower pattern.",
      chinese: "pattern = 图案；这件衬衫有花朵图案。",
    },
    "pea": {
      focusWord: "pea",
      sentence: "A pea rolled off the plate.",
      chinese: "pea = 豌豆；一颗豌豆从盘子上滚了下来。",
    },
    "peach": {
      focusWord: "peach",
      sentence: "The peach was soft and sweet.",
      chinese: "peach = 桃子；这个桃子又软又甜。",
    },
    "peak": {
      focusWord: "peak",
      sentence: "Snow covered the mountain peak.",
      chinese: "peak = 山峰；雪覆盖了山峰。",
    },
    "peanut": {
      focusWord: "peanut",
      sentence: "He ate a peanut before lunch.",
      chinese: "peanut = 花生；他午饭前吃了一颗花生。",
    },
    "pear": {
      focusWord: "pear",
      sentence: "She packed a pear in her lunchbox.",
      chinese: "pear = 梨；她在午餐盒里装了一个梨。",
    },
    "pedestrian": {
      focusWord: "pedestrian",
      sentence: "The pedestrian waited at the crossing.",
      chinese: "pedestrian = 行人；行人在人行横道旁等待。",
    },
    "pen": {
      focusWord: "pen",
      sentence: "Use a black pen for the form.",
      chinese: "pen = 钢笔；用黑色钢笔填写表格。",
    },
    "penfriend": {
      focusWord: "penfriend",
      sentence: "My penfriend lives in Canada.",
      chinese: "penfriend = 笔友；我的笔友住在加拿大。",
    },
    "penny": {
      focusWord: "penny",
      sentence: "I found a penny on the floor.",
      chinese: "penny = 便士；我在地板上找到了一枚便士。",
    },
    "pepper": {
      focusWord: "pepper",
      sentence: "Add pepper to the soup.",
      chinese: "pepper = 胡椒；往汤里加胡椒。",
    },
    "performer": {
      focusWord: "performer",
      sentence: "The performer bowed after the song.",
      chinese: "performer = 表演者；表演者唱完歌后鞠躬。",
    },
    "perfume": {
      focusWord: "perfume",
      sentence: "Her perfume smelled like roses.",
      chinese: "perfume = 香水；她的香水闻起来像玫瑰。",
    },
    "period": {
      focusWord: "period",
      sentence: "The first period starts at nine.",
      chinese: "period = 课时；第一节课九点开始。",
    },
    "permission": {
      focusWord: "permission",
      sentence: "We need permission to use the hall.",
      chinese: "permission = 许可；我们需要许可才能使用大厅。",
    },
    "pet": {
      focusWord: "pet",
      sentence: "My pet sleeps beside my bed.",
      chinese: "pet = 宠物；我的宠物睡在我的床边。",
    },
    "petrol": {
      focusWord: "petrol",
      sentence: "The car needs more petrol.",
      chinese: "petrol = 汽油；汽车需要更多汽油。",
    },
    "pharmacy": {
      focusWord: "pharmacy",
      sentence: "The pharmacy closes at six.",
      chinese: "pharmacy = 药房；药房六点关门。",
    },
    "photo": {
      focusWord: "photo",
      sentence: "I took a photo of the river.",
      chinese: "photo = 照片；我拍了一张河流的照片。",
    },
    "photocopy": {
      focusWord: "photocopy",
      sentence: "Make a photocopy of your passport.",
      chinese: "photocopy = 复印件；复印一份你的护照。",
    },
    "photograph": {
      focusWord: "photograph",
      sentence: "The photograph shows my old school.",
      chinese: "photograph = 照片；这张照片展示了我的旧学校。",
    },
    "photographer": {
      focusWord: "photographer",
      sentence: "The photographer waited for the sunset.",
      chinese: "photographer = 摄影师；摄影师等待日落。",
    },
    "photography": {
      focusWord: "photography",
      sentence: "Photography is her favourite hobby.",
      chinese: "photography = 摄影；摄影是她最喜欢的爱好。",
    },
    "phrase": {
      focusWord: "phrase",
      sentence: "Learn this useful phrase for travel.",
      chinese: "phrase = 短语；学习这个旅行中有用的短语。",
    },
    "physics": {
      focusWord: "physics",
      sentence: "Physics explains how light travels.",
      chinese: "physics = 物理；物理解释光如何传播。",
    },
    "piano": {
      focusWord: "piano",
      sentence: "The piano needs tuning.",
      chinese: "piano = 钢琴；这架钢琴需要调音。",
    },
    "picnic": {
      focusWord: "picnic",
      sentence: "We had a picnic beside the lake.",
      chinese: "picnic = 野餐；我们在湖边野餐。",
    },
    "pie": {
      focusWord: "pie",
      sentence: "Apple pie is my favourite dessert.",
      chinese: "pie = 馅饼；苹果馅饼是我最喜欢的甜点。",
    },
    "piece": {
      focusWord: "piece",
      sentence: "Take one piece of cake.",
      chinese: "piece = 块；拿一块蛋糕。",
    },
    "pig": {
      focusWord: "pig",
      sentence: "A pig slept in the shade.",
      chinese: "pig = 猪；一头猪在阴凉处睡觉。",
    },
    "pile": {
      focusWord: "pile",
      sentence: "A pile of books was on the desk.",
      chinese: "pile = 一堆；桌上有一堆书。",
    },
    "pill": {
      focusWord: "pill",
      sentence: "Take one pill after breakfast.",
      chinese: "pill = 药片；早餐后吃一片药。",
    },
    "pillow": {
      focusWord: "pillow",
      sentence: "The pillow was soft and clean.",
      chinese: "pillow = 枕头；枕头又软又干净。",
    },
    "pin": {
      focusWord: "pin",
      sentence: "Use a pin to hold the note on the board.",
      chinese: "pin = 图钉；用图钉把便条固定在板上。",
    },
    "pineapple": {
      focusWord: "pineapple",
      sentence: "Cut the pineapple into rings.",
      chinese: "pineapple = 菠萝；把菠萝切成圆片。",
    },
    "pipe": {
      focusWord: "pipe",
      sentence: "Water came from the broken pipe.",
      chinese: "pipe = 管道；水从破裂的管道里流出来。",
    },
    "pirate": {
      focusWord: "pirate",
      sentence: "The pirate found a box of gold.",
      chinese: "pirate = 海盗；海盗发现了一箱金子。",
    },
    "pitch": {
      focusWord: "pitch",
      sentence: "The football pitch was wet after the rain.",
      chinese: "pitch = 球场；雨后足球场很湿。",
    },
    "play": {
      focusWord: "play",
      sentence: "The school play starts tonight.",
      chinese: "play = 戏剧；学校戏剧今晚开始。",
    },
    "pleasure": {
      focusWord: "pleasure",
      sentence: "It was a pleasure to meet your family.",
      chinese: "pleasure = 荣幸；认识你的家人是一件荣幸的事。",
    },
    "plot": {
      focusWord: "plot",
      sentence: "The plot of the film was simple.",
      chinese: "plot = 情节；这部电影的情节很简单。",
    },
    "plug": {
      focusWord: "plug",
      sentence: "Put the plug into the wall socket.",
      chinese: "plug = 插头；把插头插进墙上的插座。",
    },
    "pocket": {
      focusWord: "pocket",
      sentence: "I put the key in my pocket.",
      chinese: "pocket = 口袋；我把钥匙放进口袋。",
    },
    "podcast": {
      focusWord: "podcast",
      sentence: "I listened to a podcast on the bus.",
      chinese: "podcast = 播客；我在公交车上听了一个播客。",
    },
    "poet": {
      focusWord: "poet",
      sentence: "The poet read a poem to the class.",
      chinese: "poet = 诗人；诗人给全班朗读了一首诗。",
    },
    "poetry": {
      focusWord: "poetry",
      sentence: "Poetry can express strong feelings.",
      chinese: "poetry = 诗歌；诗歌能表达强烈的感情。",
    },
    "port": {
      focusWord: "port",
      sentence: "The ship left the port at dawn.",
      chinese: "port = 港口；船在黎明时离开港口。",
    },
    "post": {
      focusWord: "post",
    ...
    "reporter": {
      focusWord: "reporter",
      sentence: "The reporter interviewed the footballer.",
      chinese: "reporter = 记者；记者采访了那名足球运动员。",
    },
    "request": {
      focusWord: "request",
      sentence: "The hotel accepted our request for a quiet room.",
      chinese: "request = 请求；酒店接受了我们要一间安静房间的请求。",
    },
    "resort": {
      focusWord: "resort",
      sentence: "The ski resort opens in December.",
      chinese: "resort = 度假胜地；滑雪度假胜地十二月开放。",
    },
    "respect": {
      focusWord: "respect",
      sentence: "The students showed respect for their coach.",
      chinese: "respect = 尊重；学生们尊重他们的教练。",
    },
    "rest": {
      focusWord: "rest",
      sentence: "Take a rest after the long walk.",
      chinese: "rest = 休息；长途步行后休息一下。",
    },
    "revision": {
      focusWord: "revision",
      sentence: "Revision before the exam helped me remember dates.",
      chinese: "revision = 复习；考试前复习帮助我记住日期。",
    },
    "reward": {
      focusWord: "reward",
      sentence: "The school gave a reward for honesty.",
      chinese: "reward = 奖励；学校因诚实给予奖励。",
    },
    "ride": {
      focusWord: "ride",
      sentence: "The bike ride took thirty minutes.",
      chinese: "ride = 骑行；这次骑自行车花了三十分钟。",
    },
    "rider": {
      focusWord: "rider",
      sentence: "The rider wore a black helmet.",
      chinese: "rider = 骑手；骑手戴着黑色头盔。",
    },
    "riding": {
      focusWord: "riding",
      sentence: "Riding is popular in the countryside.",
      chinese: "riding = 骑马；骑马在乡村很受欢迎。",
    },
    "robot": {
      focusWord: "robot",
      sentence: "The robot carried boxes in the factory.",
      chinese: "robot = 机器人；机器人在工厂里搬箱子。",
    },
    "rocket": {
      focusWord: "rocket",
      sentence: "The rocket rose into the sky.",
      chinese: "rocket = 火箭；火箭升上天空。",
    },
    "roll": {
      focusWord: "roll",
      sentence: "She ate a bread roll with soup.",
      chinese: "roll = 小面包；她配着汤吃了一个小面包。",
    },
    "roommate": {
      focusWord: "roommate",
      sentence: "My roommate studies music.",
      chinese: "roommate = 室友；我的室友学习音乐。",
    },
    "rope": {
      focusWord: "rope",
      sentence: "Tie the boat with this rope.",
      chinese: "rope = 绳子；用这根绳子系住船。",
    },
    "rose": {
      focusWord: "rose",
      sentence: "He gave his mother a red rose.",
      chinese: "rose = 玫瑰；他送给妈妈一朵红玫瑰。",
    },
    "roundabout": {
      focusWord: "roundabout",
      sentence: "Turn right at the roundabout.",
      chinese: "roundabout = 环岛；在环岛处右转。",
    },
    "route": {
      focusWord: "route",
      sentence: "This route avoids the busy road.",
      chinese: "route = 路线；这条路线避开了繁忙道路。",
    },
    "routine": {
      focusWord: "routine",
      sentence: "My morning routine starts with tea.",
      chinese: "routine = 常规；我的早晨常规从喝茶开始。",
    },
    "row": {
      focusWord: "row",
      sentence: "We sat in the front row.",
      chinese: "row = 排；我们坐在第一排。",
    },
    "rubber": {
      focusWord: "rubber",
      sentence: "Use a rubber to remove the pencil mark.",
      chinese: "rubber = 橡皮；用橡皮擦掉铅笔痕迹。",
    },
    "rubbish": {
      focusWord: "rubbish",
      sentence: "Put the rubbish in the bin.",
      chinese: "rubbish = 垃圾；把垃圾放进垃圾桶。",
    },
    "rug": {
      focusWord: "rug",
      sentence: "A small rug covered the wooden floor.",
      chinese: "rug = 小地毯；一块小地毯盖在木地板上。",
    },
    "ruin": {
      focusWord: "ruin",
      sentence: "The castle ruin stands above the town.",
      chinese: "ruin = 废墟；城堡废墟矗立在城镇上方。",
    },
    "ruler": {
      focusWord: "ruler",
      sentence: "Use a ruler to draw a straight line.",
      chinese: "ruler = 尺子；用尺子画一条直线。",
    },
    "runner": {
      focusWord: "runner",
      sentence: "The runner finished the race first.",
      chinese: "runner = 跑步者；跑步者第一个完成比赛。",
    },
    "running": {
      focusWord: "running",
      sentence: "Running keeps him fit.",
      chinese: "running = 跑步；跑步让他保持健康。",
    },
    "sail": {
      focusWord: "sail",
      sentence: "The white sail filled with wind.",
      chinese: "sail = 帆；白色的帆鼓满了风。",
    },
    "sailing": {
      focusWord: "sailing",
      sentence: "Sailing on the lake was peaceful.",
      chinese: "sailing = 帆船运动；在湖上进行帆船运动很平静。",
    },
    "sailor": {
      focusWord: "sailor",
      sentence: "The sailor cleaned the deck.",
      chinese: "sailor = 水手；水手清洁了甲板。",
    },
    "salary": {
      focusWord: "salary",
      sentence: "Her salary is paid every month.",
      chinese: "salary = 薪水；她的薪水每月发放。",
    },
    "salesman": {
      focusWord: "salesman",
      sentence: "The salesman explained the new phone.",
      chinese: "salesman = 男售货员；男售货员介绍了新手机。",
    },
    "salmon": {
      focusWord: "salmon",
      sentence: "Salmon is often served with lemon.",
      chinese: "salmon = 三文鱼；三文鱼常配柠檬一起上桌。",
    },
    "sand": {
      focusWord: "sand",
      sentence: "Sand covered our shoes at the beach.",
      chinese: "sand = 沙子；海滩上的沙子盖住了我们的鞋。",
    },
    "sandal": {
      focusWord: "sandal",
      sentence: "One sandal was under the bed.",
      chinese: "sandal = 凉鞋；一只凉鞋在床底下。",
    },
    "sauce": {
      focusWord: "sauce",
      sentence: "This sauce tastes of garlic.",
      chinese: "sauce = 酱汁；这种酱汁有大蒜味。",
    },
    "saucepan": {
      focusWord: "saucepan",
      sentence: "Boil the water in a saucepan.",
      chinese: "saucepan = 平底锅；在平底锅里把水烧开。",
    },
    "saucer": {
      focusWord: "saucer",
      sentence: "Put the cup on the saucer.",
      chinese: "saucer = 茶托；把杯子放在茶托上。",
    },
    "sausage": {
      focusWord: "sausage",
      sentence: "He ate a sausage for breakfast.",
      chinese: "sausage = 香肠；他早餐吃了一根香肠。",
    },
    "scarf": {
      focusWord: "scarf",
      sentence: "She wore a wool scarf in winter.",
      chinese: "scarf = 围巾；她冬天戴了一条羊毛围巾。",
    },
    "scene": {
      focusWord: "scene",
      sentence: "The final scene of the film was sad.",
      chinese: "scene = 场景；电影的最后一个场景很悲伤。",
    },
    "scenery": {
      focusWord: "scenery",
      sentence: "The mountain scenery was beautiful.",
      chinese: "scenery = 风景；山间风景很美。",
    },
    "scientist": {
      focusWord: "scientist",
      sentence: "The scientist tested the water.",
      chinese: "scientist = 科学家；科学家检测了水。",
    },
    "scissors": {
      focusWord: "scissors",
      sentence: "These scissors can cut thick paper.",
      chinese: "scissors = 剪刀；这把剪刀能剪厚纸。",
    },
    "scooter": {
      focusWord: "scooter",
      sentence: "He rode a scooter to the shop.",
      chinese: "scooter = 小型摩托车；他骑小型摩托车去了商店。",
    },
    "scream": {
      focusWord: "scream",
      sentence: "A scream came from the old house.",
      chinese: "scream = 尖叫声；尖叫声从旧房子里传来。",
    },
    "sculpture": {
      focusWord: "sculpture",
      sentence: "The stone sculpture stood in the square.",
      chinese: "sculpture = 雕塑；石雕矗立在广场上。",
    },
    "search": {
      focusWord: "search",
      sentence: "The search for the lost dog lasted all night.",
      chinese: "search = 搜索；寻找走失狗的搜索持续了一整夜。",
    },
    "seaside": {
      focusWord: "seaside",
      sentence: "We spent Sunday at the seaside.",
      chinese: "seaside = 海边；我们星期天在海边度过。",
    },
    "seat": {
      focusWord: "seat",
    ...
    tune: {
      focusWord: "tune",
      sentence: "The tune was easy to remember.",
      chinese: "tune = 曲调；这段曲调很容易记住。",
    },
    tunnel: {
      focusWord: "tunnel",
      sentence: "The train went through a long tunnel.",
      chinese: "tunnel = 隧道；火车穿过了一条长隧道。",
    },
    turkey: {
      focusWord: "turkey",
      sentence: "We ate turkey for lunch.",
      chinese: "turkey = 火鸡肉；我们午饭吃了火鸡肉。",
    },
    turning: {
      focusWord: "turning",
      sentence: "Take the next turning on the left.",
      chinese: "turning = 转弯处；在下一个转弯处向左转。",
    },
    twin: {
      focusWord: "twin",
      sentence: "My twin wears glasses.",
      chinese: "twin = 双胞胎之一；我的双胞胎兄弟戴眼镜。",
    },
    type: {
      focusWord: "type",
      sentence: "This type of music is loud.",
      chinese: "type = 类型；这种类型的音乐很响。",
    },
    tyre: {
      focusWord: "tyre",
      sentence: "The car has a flat tyre.",
      chinese: "tyre = 轮胎；这辆车有一个轮胎瘪了。",
    },
    umbrella: {
      focusWord: "umbrella",
      sentence: "Take an umbrella because it may rain.",
      chinese: "umbrella = 雨伞；带上雨伞，因为可能会下雨。",
    },
    unhappy: {
      focusWord: "unhappy",
      sentence: "His unhappy face worried me.",
      chinese: "unhappy = 不高兴的；他不高兴的脸让我担心。",
    },
    union: {
      focusWord: "union",
      sentence: "The student union organized a party.",
      chinese: "union = 联合会；学生会组织了一场聚会。",
    },
    unit: {
      focusWord: "unit",
      sentence: "This unit of the book is about travel.",
      chinese: "unit = 单元；这本书的这个单元是关于旅行的。",
    },
    universe: {
      focusWord: "universe",
      sentence: "Stars fill the universe.",
      chinese: "universe = 宇宙；星星布满宇宙。",
    },
    user: {
      focusWord: "user",
      sentence: "Each user needs a password.",
      chinese: "user = 用户；每个用户都需要一个密码。",
    },
    valley: {
      focusWord: "valley",
      sentence: "The valley was green after the rain.",
      chinese: "valley = 山谷；雨后山谷一片翠绿。",
    },
    van: {
      focusWord: "van",
      sentence: "The delivery van stopped outside.",
      chinese: "van = 小货车；送货小货车停在外面。",
    },
    vanilla: {
      focusWord: "vanilla",
      sentence: "Vanilla is my favourite ice cream flavour.",
      chinese: "vanilla = 香草；香草是我最喜欢的冰淇淋口味。",
    },
    variety: {
      focusWord: "variety",
      sentence: "The shop sells a variety of hats.",
      chinese: "variety = 种类；这家商店出售各种帽子。",
    },
    vase: {
      focusWord: "vase",
      sentence: "Put the flowers in the vase.",
      chinese: "vase = 花瓶；把花放进花瓶里。",
    },
    vegetarian: {
      focusWord: "vegetarian",
      sentence: "The vegetarian ordered mushroom pasta.",
      chinese: "vegetarian = 素食者；素食者点了蘑菇意面。",
    },
    vehicle: {
      focusWord: "vehicle",
      sentence: "This vehicle carries eight people.",
      chinese: "vehicle = 车辆；这辆车能载八个人。",
    },
    version: {
      focusWord: "version",
      sentence: "I downloaded the latest version.",
      chinese: "version = 版本；我下载了最新版本。",
    },
    vet: {
      focusWord: "vet",
      sentence: "The vet checked our cat.",
      chinese: "vet = 兽医；兽医检查了我们的猫。",
    },
    view: {
      focusWord: "view",
      sentence: "The hotel room has a sea view.",
      chinese: "view = 景色；这间酒店房间能看到海景。",
    },
    violin: {
      focusWord: "violin",
      sentence: "She plays the violin after school.",
      chinese: "violin = 小提琴；她放学后拉小提琴。",
    },
    virus: {
      focusWord: "virus",
      sentence: "A virus made his computer slow.",
      chinese: "virus = 病毒；病毒让他的电脑变慢了。",
    },
    visa: {
      focusWord: "visa",
      sentence: "You need a visa to enter the country.",
      chinese: "visa = 签证；进入这个国家需要签证。",
    },
    visitor: {
      focusWord: "visitor",
      sentence: "The visitor signed the book.",
      chinese: "visitor = 访客；访客在本子上签了名。",
    },
    voice: {
      focusWord: "voice",
      sentence: "Her voice was soft and calm.",
      chinese: "voice = 声音；她的声音轻柔而平静。",
    },
    volume: {
      focusWord: "volume",
      sentence: "Turn down the volume of the radio.",
      chinese: "volume = 音量；把收音机的音量调低。",
    },
    volunteer: {
      focusWord: "volunteer",
      sentence: "A volunteer helped at the race.",
      chinese: "volunteer = 志愿者；一名志愿者在比赛中帮忙。",
    },
    vote: {
      focusWord: "vote",
      sentence: "Each student has one vote.",
      chinese: "vote = 选票；每个学生有一张选票。",
    },
    vowel: {
      focusWord: "vowel",
      sentence: "A is a vowel in English.",
      chinese: "vowel = 元音字母；A 是英语里的元音字母。",
    },
    wage: {
      focusWord: "wage",
      sentence: "The weekly wage was low.",
      chinese: "wage = 工资；周工资很低。",
    },
    walking: {
      focusWord: "walking",
      sentence: "Walking is good exercise.",
      chinese: "walking = 步行；步行是很好的锻炼。",
    },
    war: {
      focusWord: "war",
      sentence: "The museum has photos from the war.",
      chinese: "war = 战争；博物馆有战争时期的照片。",
    },
    wardrobe: {
      focusWord: "wardrobe",
      sentence: "Her dresses hung in the wardrobe.",
      chinese: "wardrobe = 衣柜；她的连衣裙挂在衣柜里。",
    },
    warning: {
      focusWord: "warning",
      sentence: "The warning was printed in red.",
      chinese: "warning = 警告；警告用红色印着。",
    },
    wash: {
      focusWord: "wash",
      sentence: "This shirt needs a wash.",
      chinese: "wash = 洗涤；这件衬衫需要洗一下。",
    },
    washingmachine: {
      focusWord: "washing machine",
      sentence: "The washing machine is noisy.",
      chinese: "washing machine = 洗衣机；这台洗衣机很吵。",
    },
    washingup: {
      focusWord: "washing-up",
      sentence: "The washing-up was left in the sink.",
      chinese: "washing-up = 洗碗；要洗的碗盘留在了水槽里。",
    },
    waterfall: {
      focusWord: "waterfall",
      sentence: "We took photos of the waterfall.",
      chinese: "waterfall = 瀑布；我们拍了瀑布的照片。",
    },
    wave: {
      focusWord: "wave",
      sentence: "A large wave hit the rocks.",
      chinese: "wave = 海浪；一个大浪拍打着岩石。",
    },
    way: {
      focusWord: "way",
      sentence: "This way leads to the station.",
      chinese: "way = 路；这条路通向车站。",
    },
    web: {
      focusWord: "web",
      sentence: "A spider's web hung in the corner.",
      chinese: "web = 网；角落里挂着一张蜘蛛网。",
    },
    webcam: {
      focusWord: "webcam",
      sentence: "My webcam stopped working during the call.",
      chinese: "webcam = 网络摄像头；通话时我的网络摄像头坏了。",
    },
    webpage: {
      focusWord: "web page",
      sentence: "The web page loaded slowly.",
      chinese: "web page = 网页；这个网页加载得很慢。",
    },
    wedding: {
      focusWord: "wedding",
      sentence: "The wedding was in June.",
      chinese: "wedding = 婚礼；婚礼在六月举行。",
    },
    weekday: {
      focusWord: "weekday",
      sentence: "Monday is a weekday.",
      chinese: "weekday = 工作日；星期一是工作日。",
    },
    weekend: {
      focusWord: "weekend",
      sentence: "We went camping at the weekend.",
      chinese: "weekend = 周末；我们周末去露营了。",
    },
    welcome: {
      focusWord: "welcome",
      sentence: "The warm welcome made us happy.",
      chinese: "welcome = 欢迎；热情的欢迎让我们很高兴。",
    },
    wetsuit: {
      focusWord: "wetsuit",
      sentence: "The surfer wore a black wetsuit.",
      chinese: "wetsuit = 潜水服；冲浪者穿着黑色潜水服。",
    },
    whale: {
      focusWord: "whale",
      sentence: "A whale rose beside the boat.",
      chinese: "whale = 鲸；一头鲸在船旁浮出水面。",
    },
    wheel: {
      focusWord: "wheel",
      sentence: "The wheel of my bike is bent.",
      chinese: "wheel = 轮子；我的自行车轮子弯了。",
    },
    wheelchair: {
      focusWord: "wheelchair",
      sentence: "The museum entrance is wide enough for a wheelchair.",
      chinese: "wheelchair = 轮椅；博物馆入口宽到足够轮椅通过。",
    },
    windscreen: {
      focusWord: "windscreen",
      sentence: "Rain covered the car windscreen.",
      chinese: "windscreen = 挡风玻璃；雨水覆盖了汽车挡风玻璃。",
    },
    windsurfing: {
      focusWord: "windsurfing",
      sentence: "Windsurfing is popular on this lake.",
      chinese: "windsurfing = 风帆冲浪；风帆冲浪在这个湖上很受欢迎。",
    },
    wing: {
      focusWord: "wing",
      sentence: "The bird hurt one wing.",
      chinese: "wing = 翅膀；那只鸟伤了一只翅膀。",
    },
    winner: {
      focusWord: "winner",
      sentence: "The winner received a silver cup.",
      chinese: "winner = 获胜者；获胜者得到了一只银杯。",
    },
    workoutnoun: {
      focusWord: "workout",
    ...
    worry: {
      focusWord: "worry",
      sentence: "Money was her main worry.",
      chinese: "worry = 担心的事；钱是她主要担心的事。",
    },
    writer: {
      focusWord: "writer",
      sentence: "The writer signed my book.",
      chinese: "writer = 作家；作家在我的书上签了名。",
    },
    writing: {
      focusWord: "writing",
      sentence: "Her writing is clear and neat.",
      chinese: "writing = 字迹；她的字迹清楚整洁。",
    },
    yard: {
      focusWord: "yard",
      sentence: "The children played in the yard.",
      chinese: "yard = 院子；孩子们在院子里玩。",
    },
    yogurt: {
      focusWord: "yogurt",
      sentence: "I ate yogurt with fruit.",
      chinese: "yogurt = 酸奶；我吃了水果酸奶。",
    },
    youth: {
      focusWord: "youth",
      sentence: "The club works with local youth.",
      chinese: "youth = 青年；这个俱乐部与当地青年合作。",
    },
    zero: {
      focusWord: "zero",
      sentence: "The score was zero at half-time.",
      chinese: "zero = 零；半场时比分是零。",
    },
    zone: {
      focusWord: "zone",
      sentence: "This is a quiet zone.",
      chinese: "zone = 区域；这是安静区域。",
    },
    zoo: {
      focusWord: "zoo",
      sentence: "The zoo has two new penguins.",
      chinese: "zoo = 动物园；动物园有两只新企鹅。",
    },
    absent: {
      focusWord: "absent",
      sentence: "The absent student missed the test.",
      chinese: "absent = 缺席的；缺席的学生错过了考试。",
    },
    acceptable: {
      focusWord: "acceptable",
      sentence: "This answer is acceptable.",
      chinese: "acceptable = 可接受的；这个答案可以接受。",
    },
    accurate: {
      focusWord: "accurate",
      sentence: "The map is accurate.",
      chinese: "accurate = 准确的；这张地图很准确。",
    },
    active: {
      focusWord: "active",
      sentence: "My grandfather is still active.",
      chinese: "active = 活跃的；我的祖父仍然很活跃。",
    },
    advanced: {
      focusWord: "advanced",
      sentence: "She joined an advanced English class.",
      chinese: "advanced = 高级的；她参加了高级英语班。",
    },
    alive: {
      focusWord: "alive",
      sentence: "The fish was still alive.",
      chinese: "alive = 活着的；那条鱼还活着。",
    },
    alright: {
      focusWord: "alright",
      sentence: "Don't worry; everything is alright.",
      chinese: "alright = 没问题；别担心，一切都没问题。",
    },
    ancient: {
      focusWord: "ancient",
      sentence: "We visited an ancient temple.",
      chinese: "ancient = 古老的；我们参观了一座古老的寺庙。",
    },
    annual: {
      focusWord: "annual",
      sentence: "The annual school concert is in May.",
      chinese: "annual = 年度的；学校年度音乐会在五月举行。",
    },
    antique: {
      focusWord: "antique",
      sentence: "She bought an antique clock.",
      chinese: "antique = 古董的；她买了一个古董钟。",
    },
    asleep: {
      focusWord: "asleep",
      sentence: "The baby is asleep.",
      chinese: "asleep = 睡着的；宝宝睡着了。",
    },
    attractive: {
      focusWord: "attractive",
      sentence: "The poster has an attractive design.",
      chinese: "attractive = 有吸引力的；这张海报设计得很有吸引力。",
    },
    available: {
      focusWord: "available",
      sentence: "Tickets are available online.",
      chinese: "available = 可获得的；门票可以在网上买到。",
    },
    awake: {
      focusWord: "awake",
      sentence: "I was awake at midnight.",
      chinese: "awake = 醒着的；午夜时我还醒着。",
    },
    awesome: {
      focusWord: "awesome",
      sentence: "The view from the hill was awesome.",
      chinese: "awesome = 极好的；山上的景色极好。",
    },
    bad: {
      focusWord: "bad",
      sentence: "The weather was bad yesterday.",
      chinese: "bad = 糟糕的；昨天天气很糟糕。",
    },
    bald: {
      focusWord: "bald",
      sentence: "The bald man wore a hat.",
      chinese: "bald = 秃头的；那个秃头男人戴着帽子。",
    },
    basic: {
      focusWord: "basic",
      sentence: "This course teaches basic grammar.",
      chinese: "basic = 基本的；这门课程教授基本语法。",
    },
    beautiful: {
      focusWord: "beautiful",
      sentence: "The garden is beautiful in spring.",
      chinese: "beautiful = 美丽的；春天的花园很美。",
    },
    best: {
      focusWord: "best",
      sentence: "This is the best answer.",
      chinese: "best = 最好的；这是最好的答案。",
    },
    better: {
      focusWord: "better",
      sentence: "She feels better today.",
      chinese: "better = 更好的；她今天感觉好多了。",
    },
    big: {
      focusWord: "big",
      sentence: "They live in a big house.",
      chinese: "big = 大的；他们住在一所大房子里。",
    },
    bitter: {
      focusWord: "bitter",
      sentence: "The coffee tastes bitter.",
      chinese: "bitter = 苦的；这杯咖啡尝起来很苦。",
    },
    black: {
      focusWord: "black",
      sentence: "She wore a black coat.",
      chinese: "black = 黑色的；她穿了一件黑色外套。",
    },
    blind: {
      focusWord: "blind",
      sentence: "The blind singer performed beautifully.",
      chinese: "blind = 失明的；那位失明的歌手表演得很美。",
    },
    blond: {
      focusWord: "blond",
      sentence: "The blond child waved at us.",
      chinese: "blond = 金发的；那个金发孩子向我们挥手。",
    },
    blue: {
      focusWord: "blue",
      sentence: "He chose a blue shirt.",
      chinese: "blue = 蓝色的；他选了一件蓝色衬衫。",
    },
    boiled: {
      focusWord: "boiled",
      sentence: "We ate boiled potatoes.",
      chinese: "boiled = 煮熟的；我们吃了煮熟的土豆。",
    },
    bold: {
      focusWord: "bold",
      sentence: "The bold title was easy to read.",
      chinese: "bold = 粗体的；粗体标题很容易阅读。",
    },
    born: {
      focusWord: "born",
      sentence: "She was born in April.",
      chinese: "born = 出生的；她出生在四月。",
    },
    bossy: {
      focusWord: "bossy",
      sentence: "His bossy sister told everyone what to do.",
      chinese: "bossy = 专横的；他专横的姐姐指挥每个人做事。",
    },
    bottom: {
      focusWord: "bottom",
      sentence: "Sign on the bottom line.",
      chinese: "bottom = 底部的；在底部那一行签名。",
    },
    brandnew: {
      focusWord: "brand new",
      sentence: "She bought a brand new bike.",
      chinese: "brand new = 崭新的；她买了一辆崭新的自行车。",
    },
    brief: {
      focusWord: "brief",
      sentence: "The teacher gave a brief explanation.",
      chinese: "brief = 简短的；老师做了简短的解释。",
    },
    brilliant: {
      focusWord: "brilliant",
      sentence: "His idea was brilliant.",
      chinese: "brilliant = 出色的；他的想法很出色。",
    },
    broad: {
      focusWord: "broad",
      sentence: "A broad path led to the lake.",
      chinese: "broad = 宽阔的；一条宽阔的小路通向湖边。",
    },
    broken: {
      focusWord: "broken",
      sentence: "The broken chair was in the corner.",
      chinese: "broken = 坏了的；坏椅子在角落里。",
    },
    brown: {
      focusWord: "brown",
      sentence: "The dog has brown ears.",
      chinese: "brown = 棕色的；这只狗有棕色耳朵。",
    },
    burning: {
      focusWord: "burning",
      sentence: "The burning candle lit the room.",
      chinese: "burning = 燃烧的；燃烧的蜡烛照亮了房间。",
    },
    busy: {
      focusWord: "busy",
      sentence: "The cafe was busy at lunchtime.",
      chinese: "busy = 忙碌的；午餐时间咖啡馆很忙。",
    },
    capital: {
      focusWord: "capital",
      sentence: "London is the capital city of the UK.",
      chinese: "capital = 首都的；伦敦是英国的首都城市。",
    },
    cardboard: {
      focusWord: "cardboard",
      sentence: "The cardboard box was light.",
      chinese: "cardboard = 纸板的；这个纸板箱很轻。",
    },
    careful: {
      focusWord: "careful",
      sentence: "Be careful on the icy road.",
      chinese: "careful = 小心的；在结冰的路上要小心。",
    },
    careless: {
      focusWord: "careless",
      sentence: "A careless mistake cost him a mark.",
      chinese: "careless = 粗心的；一个粗心的错误让他丢了一分。",
    },
    casual: {
      focusWord: "casual",
      sentence: "Wear casual clothes to the picnic.",
      chinese: "casual = 休闲的；野餐时穿休闲衣服。",
    },
    central: {
      focusWord: "central",
      sentence: "Our hotel is in a central area.",
      chinese: "central = 中心的；我们的酒店在中心区域。",
    },
    certain: {
      focusWord: "certain",
      sentence: "I am certain that the shop is open.",
      chinese: "certain = 确信的；我确信商店开着。",
    },
    challenging: {
      focusWord: "challenging",
      sentence: "The mountain walk was challenging.",
      chinese: "challenging = 有挑战性的；这次山路徒步很有挑战性。",
    },
    charming: {
      focusWord: "charming",
      sentence: "The village has a charming square.",
      chinese: "charming = 迷人的；这个村庄有一个迷人的广场。",
    },
    clever: {
      focusWord: "clever",
      sentence: "The clever child solved the puzzle.",
      chinese: "clever = 聪明的；聪明的孩子解开了谜题。",
    },
    close: {
      focusWord: "close",
      sentence: "The station is close to our hotel.",
      chinese: "close = 近的；车站离我们的酒店很近。",
    },
    closed: {
      focusWord: "closed",
      sentence: "The library is closed on Mondays.",
      chinese: "closed = 关闭的；图书馆星期一关闭。",
    },
    colourful: {
      focusWord: "colourful",
      sentence: "She wore a colourful dress.",
      chinese: "colourful = 色彩鲜艳的；她穿了一条色彩鲜艳的连衣裙。",
    },
    complicated: {
      focusWord: "complicated",
      sentence: "The instructions were complicated.",
      chinese: "complicated = 复杂的；说明很复杂。",
    },
    confusing: {
      focusWord: "confusing",
      sentence: "The map was confusing.",
      chinese: "confusing = 令人困惑的；这张地图令人困惑。",
    },
    convenient: {
      focusWord: "convenient",
      sentence: "The new bus stop is convenient.",
      chinese: "convenient = 方便的；新的公交站很方便。",
    },
    correct: {
      focusWord: "correct",
      sentence: "Your answer is correct.",
      chinese: "correct = 正确的；你的答案是正确的。",
    },
    cosy: {
      focusWord: "cosy",
      sentence: "The small room felt cosy.",
      chinese: "cosy = 舒适的；这个小房间让人觉得舒适。",
    },
    cream: {
      focusWord: "cream",
      sentence: "She wore a cream scarf.",
      chinese: "cream = 奶油色的；她戴了一条奶油色围巾。",
    },
    creative: {
      focusWord: "creative",
      sentence: "The creative student made a poster.",
      chinese: "creative = 有创造力的；有创造力的学生做了一张海报。",
    },
    crowded: {
      focusWord: "crowded",
      sentence: "The train was crowded.",
      chinese: "crowded = 拥挤的；火车很拥挤。",
    },
    cruel: {
      focusWord: "cruel",
      sentence: "The cruel joke upset him.",
      chinese: "cruel = 残忍的；这个残忍的玩笑让他难过。",
    },
    cultural: {
      focusWord: "cultural",
      sentence: "The city has many cultural events.",
      chinese: "cultural = 文化的；这座城市有许多文化活动。",
    },
    curious: {
      focusWord: "curious",
      sentence: "The curious child asked many questions.",
      chinese: "curious = 好奇的；好奇的孩子问了很多问题。",
    },
    curly: {
      focusWord: "curly",
      sentence: "She has curly hair.",
      chinese: "curly = 卷曲的；她有卷发。",
    },
    cute: {
      focusWord: "cute",
      sentence: "The puppy is cute.",
      chinese: "cute = 可爱的；这只小狗很可爱。",
    },
    daily: {
      focusWord: "daily",
      sentence: "Daily exercise keeps him healthy.",
      chinese: "daily = 每日的；每日锻炼让他保持健康。",
    },
    damaged: {
      focusWord: "damaged",
      sentence: "The damaged phone would not start.",
      chinese: "damaged = 损坏的；损坏的手机无法启动。",
    },
    dangerous: {
      focusWord: "dangerous",
      sentence: "The road is dangerous at night.",
      chinese: "dangerous = 危险的；这条路夜里很危险。",
    },
    dead: {
      focusWord: "dead",
      sentence: "The plant was dead after the heat.",
      chinese: "dead = 死的；高温之后那株植物死了。",
    },
    deaf: {
      focusWord: "deaf",
      sentence: "The deaf student used sign language.",
      chinese: "deaf = 失聪的；失聪的学生使用手语。",
    },
    dear: {
      focusWord: "dear",
      sentence: "Dear Grandma, thank you for the gift.",
      chinese: "dear = 亲爱的；亲爱的奶奶，谢谢您的礼物。",
    },
    delayed: {
      focusWord: "delayed",
      sentence: "The delayed flight arrived at midnight.",
      chinese: "delayed = 延误的；延误的航班午夜抵达。",
    },
    delicious: {
      focusWord: "delicious",
      sentence: "The soup was delicious.",
      chinese: "delicious = 美味的；这汤很美味。",
    },
    different: {
      focusWord: "different",
      sentence: "We chose different colours.",
      chinese: "different = 不同的；我们选择了不同的颜色。",
    },
    difficult: {
      focusWord: "difficult",
      sentence: "The exam was difficult.",
      chinese: "difficult = 困难的；考试很难。",
    },
    direct: {
      focusWord: "direct",
      sentence: "We took a direct train to London.",
      chinese: "direct = 直达的；我们乘直达火车去了伦敦。",
    },
    disabled: {
      focusWord: "disabled",
      sentence: "The disabled athlete won a medal.",
      chinese: "disabled = 残疾的；那位残疾运动员赢得了奖牌。",
    },
    disgusting: {
      focusWord: "disgusting",
      sentence: "The old milk smelled disgusting.",
      chinese: "disgusting = 令人恶心的；过期牛奶闻起来令人恶心。",
    },
    downstairs: {
      focusWord: "downstairs",
      sentence: "The downstairs bathroom is small.",
      chinese: "downstairs = 楼下的；楼下的浴室很小。",
    },
    dressed: {
      focusWord: "dressed",
      sentence: "The children were dressed for the party.",
      chinese: "dressed = 穿着衣服的；孩子们穿好衣服准备参加聚会。",
    },
    due: {
      focusWord: "due",
      sentence: "The homework is due tomorrow.",
      chinese: "due = 到期的；作业明天到期。",
    },
    dull: {
      focusWord: "dull",
      sentence: "The lecture was dull.",
      chinese: "dull = 乏味的；讲座很乏味。",
    },
    dutyfree: {
      focusWord: "duty-free",
      sentence: "She bought duty-free perfume at the airport.",
      chinese: "duty-free = 免税的；她在机场买了免税香水。",
    },
    eastern: {
      focusWord: "eastern",
      sentence: "The eastern gate opens first.",
      chinese: "eastern = 东部的；东门最先开放。",
    },
    easy: {
      focusWord: "easy",
      sentence: "This question is easy.",
      chinese: "easy = 容易的；这个问题很容易。",
    },
    easygoing: {
      focusWord: "easygoing",
      sentence: "Our new teacher is easygoing.",
      chinese: "easygoing = 随和的；我们的新老师很随和。",
    },
    efficient: {
      focusWord: "efficient",
      sentence: "The efficient system saves time.",
      chinese: "efficient = 高效的；高效的系统节省时间。",
    },
    elder: {
      focusWord: "elder",
      sentence: "My elder brother studies medicine.",
      chinese: "elder = 年长的；我的哥哥学医。",
    },
    elderly: {
      focusWord: "elderly",
      sentence: "An elderly woman sat near the door.",
      chinese: "elderly = 年老的；一位老妇人坐在门附近。",
    },
    electric: {
      focusWord: "electric",
      sentence: "The electric car is quiet.",
      chinese: "electric = 电动的；这辆电动车很安静。",
    },
    electrical: {
      focusWord: "electrical",
      sentence: "The electrical equipment must stay dry.",
      chinese: "electrical = 电气的；电气设备必须保持干燥。",
    },
    empty: {
      focusWord: "empty",
      sentence: "The bottle was empty.",
      chinese: "empty = 空的；瓶子是空的。",
    },
    engaged: {
      focusWord: "engaged",
      sentence: "My cousin is engaged to a doctor.",
      chinese: "engaged = 订婚的；我的表姐和一名医生订婚了。",
    },
    enjoyable: {
      focusWord: "enjoyable",
      sentence: "The trip was enjoyable.",
      chinese: "enjoyable = 令人愉快的；这次旅行令人愉快。",
    },
    enormous: {
      focusWord: "enormous",
      sentence: "An enormous ship entered the port.",
      chinese: "enormous = 巨大的；一艘巨大的船驶入港口。",
    },
    equal: {
      focusWord: "equal",
      sentence: "The two teams had equal scores.",
      chinese: "equal = 相等的；两队得分相等。",
    },
    essential: {
      focusWord: "essential",
      sentence: "Water is essential for life.",
      chinese: "essential = 必要的；水对生命是必要的。",
    },
    exact: {
      focusWord: "exact",
      sentence: "Tell me the exact time.",
      chinese: "exact = 精确的；告诉我精确时间。",
    },
    excellent: {
      focusWord: "excellent",
      sentence: "Her English is excellent.",
      chinese: "excellent = 优秀的；她的英语很优秀。",
    },
    extra: {
      focusWord: "extra",
      sentence: "Take an extra jacket.",
      chinese: "extra = 额外的；带上一件额外的夹克。",
    },
    extraordinary: {
      focusWord: "extraordinary",
      sentence: "The singer had an extraordinary voice.",
      chinese: "extraordinary = 非凡的；那位歌手有非凡的嗓音。",
    },
    fair: {
      focusWord: "fair",
      sentence: "The referee made a fair decision.",
      chinese: "fair = 公平的；裁判做出了公平的决定。",
    },
    false: {
      focusWord: "false",
      sentence: "The story was false.",
      chinese: "false = 错误的；这个故事是假的。",
    },
    familiar: {
      focusWord: "familiar",
      sentence: "The street looked familiar.",
      chinese: "familiar = 熟悉的；这条街看起来很熟悉。",
    },
    famous: {
      focusWord: "famous",
      sentence: "A famous actor visited our school.",
      chinese: "famous = 著名的；一位著名演员参观了我们学校。",
    },
    fantastic: {
      focusWord: "fantastic",
      sentence: "The concert was fantastic.",
      chinese: "fantastic = 极好的；音乐会棒极了。",
    },
    fashionable: {
      focusWord: "fashionable",
      sentence: "Those shoes are fashionable.",
      chinese: "fashionable = 时髦的；那双鞋很时髦。",
    },
    fast: {
      focusWord: "fast",
      sentence: "The fast train arrived early.",
      chinese: "fast = 快的；快车提前到达了。",
    },
    fat: {
      focusWord: "fat",
      sentence: "The fat cat slept on the sofa.",
      chinese: "fat = 胖的；那只胖猫睡在沙发上。",
    },
    favourite: {
      focusWord: "favourite",
      sentence: "Blue is my favourite colour.",
      chinese: "favourite = 最喜欢的；蓝色是我最喜欢的颜色。",
    },
    final: {
      focusWord: "final",
      sentence: "The final question was easy.",
      chinese: "final = 最后的；最后一个问题很容易。",
    },
    financial: {
      focusWord: "financial",
      sentence: "The family needed financial advice.",
      chinese: "financial = 财务的；这家人需要财务建议。",
    },
    fine: {
      focusWord: "fine",
      sentence: "I'm fine after the rest.",
      chinese: "fine = 好的；休息后我很好。",
    },
    first: {
      focusWord: "first",
      sentence: "Her first lesson starts at nine.",
      chinese: "first = 第一的；她的第一节课九点开始。",
    },
    foggy: {
      focusWord: "foggy",
      sentence: "It was foggy near the river.",
      chinese: "foggy = 有雾的；河边有雾。",
    },
    folk: {
      focusWord: "folk",
      sentence: "We listened to folk music.",
      chinese: "folk = 民间的；我们听了民间音乐。",
    },
    following: {
      focusWord: "following",
      sentence: "Read the following sentence.",
      chinese: "following = 接下来的；阅读接下来的句子。",
    },
    fond: {
      focusWord: "fond",
      sentence: "She is fond of classical music.",
      chinese: "fond = 喜爱的；她喜爱古典音乐。",
    },
    forbidden: {
      focusWord: "forbidden",
      sentence: "Swimming is forbidden here.",
      chinese: "forbidden = 禁止的；这里禁止游泳。",
    },
    foreign: {
      focusWord: "foreign",
      sentence: "He enjoys foreign films.",
      chinese: "foreign = 外国的；他喜欢外国电影。",
    },
    former: {
      focusWord: "former",
      sentence: "My former teacher lives nearby.",
      chinese: "former = 以前的；我以前的老师住在附近。",
    },
    free: {
      focusWord: "free",
      sentence: "The museum is free on Sundays.",
      chinese: "free = 免费的；博物馆星期天免费。",
    },
    freezing: {
      focusWord: "freezing",
      sentence: "The water was freezing.",
      chinese: "freezing = 极冷的；水冰冷刺骨。",
    },
    frequent: {
      focusWord: "frequent",
      sentence: "Frequent rain delayed the work.",
      chinese: "frequent = 频繁的；频繁下雨耽误了工作。",
    },
    fried: {
      focusWord: "fried",
      sentence: "He ordered fried fish.",
      chinese: "fried = 油炸的；他点了炸鱼。",
    },
    friendly: {
      focusWord: "friendly",
      sentence: "The hotel staff were friendly.",
      chinese: "friendly = 友好的；酒店员工很友好。",
    },
    front: {
      focusWord: "front",
      sentence: "Use the front door.",
      chinese: "front = 前面的；使用前门。",
    },
    frozen: {
      focusWord: "frozen",
      sentence: "We bought frozen peas.",
      chinese: "frozen = 冷冻的；我们买了冷冻豌豆。",
    },
    full: {
      focusWord: "full",
      sentence: "The bus was full.",
      chinese: "full = 满的；公交车满员了。",
    },
    furthest: {
      focusWord: "furthest",
      sentence: "The furthest village is twenty kilometres away.",
      chinese: "furthest = 最远的；最远的村庄在二十公里外。",
    },
    future: {
      focusWord: "future",
      sentence: "Future plans depend on the weather.",
      chinese: "future = 未来的；未来计划取决于天气。",
    },
    general: {
      focusWord: "general",
      sentence: "The general idea is clear.",
      chinese: "general = 大体的；大体意思很清楚。",
    },
    generous: {
      focusWord: "generous",
      sentence: "Her generous gift helped the club.",
      chinese: "generous = 慷慨的；她慷慨的礼物帮助了俱乐部。",
    },
    gentle: {
      focusWord: "gentle",
      sentence: "The nurse had a gentle voice.",
      chinese: "gentle = 温柔的；护士声音温柔。",
    },
    giant: {
      focusWord: "giant",
      sentence: "A giant screen showed the match.",
      chinese: "giant = 巨大的；一块巨大屏幕播放了比赛。",
    },
    golden: {
      focusWord: "golden",
      sentence: "The golden leaves covered the path.",
      chinese: "golden = 金色的；金色树叶覆盖了小路。",
    },
    good: {
      focusWord: "good",
      sentence: "That is a good idea.",
      chinese: "good = 好的；那是个好主意。",
    },
    goodlooking: {
      focusWord: "good-looking",
      sentence: "The good-looking actor smiled at the camera.",
      chinese: "good-looking = 好看的；那位好看的演员对着镜头微笑。",
    },
    gorgeous: {
      focusWord: "gorgeous",
      sentence: "She wore a gorgeous dress.",
      chinese: "gorgeous = 漂亮的；她穿了一条漂亮的连衣裙。",
    },
    grateful: {
      focusWord: "grateful",
      sentence: "I am grateful for your help.",
      chinese: "grateful = 感激的；我很感激你的帮助。",
    },
    great: {
      focusWord: "great",
      sentence: "We had a great holiday.",
      chinese: "great = 很棒的；我们度过了一个很棒的假期。",
    },
    grey: {
      focusWord: "grey",
      sentence: "Grey clouds covered the sky.",
      chinese: "grey = 灰色的；灰色云层遮住了天空。",
    },
    grilled: {
      focusWord: "grilled",
      sentence: "The grilled chicken smelled delicious.",
      chinese: "grilled = 烤的；烤鸡闻起来很香。",
    },
    guilty: {
      focusWord: "guilty",
      sentence: "He felt guilty about the broken window.",
      chinese: "guilty = 内疚的；他对打破窗户感到内疚。",
    },
    handsome: {
      focusWord: "handsome",
      sentence: "The handsome prince rode a horse.",
      chinese: "handsome = 英俊的；英俊的王子骑着马。",
    },
    hard: {
      focusWord: "hard",
      sentence: "The exam was hard.",
      chinese: "hard = 困难的；考试很难。",
    },
    heavy: {
      focusWord: "heavy",
      sentence: "The heavy bag hurt my shoulder.",
      chinese: "heavy = 重的；沉重的包弄疼了我的肩膀。",
    },
    hidden: {
      focusWord: "hidden",
      sentence: "The hidden key was under the mat.",
      chinese: "hidden = 隐藏的；隐藏的钥匙在垫子下面。",
    },
    highjump: {
      focusWord: "high jump",
    ...
    "knit": {
      focusWord: "knit",
      sentence: "My grandmother knitted a warm scarf.",
      chinese: "knit = 编织；我奶奶织了一条暖和的围巾。",
    },
    "knock": {
      focusWord: "knock",
      sentence: "Please knock before entering the room.",
      chinese: "knock = 敲门；进入房间前请先敲门。",
    },
    "know": {
      focusWord: "know",
      sentence: "Do you know the answer?",
      chinese: "know = 知道；你知道答案吗？",
    },
    "laugh": {
      focusWord: "laugh",
      sentence: "Everyone laughed at his joke.",
      chinese: "laugh = 笑；大家听了他的笑话都笑了。",
    },
    "lay": {
      focusWord: "lay",
      sentence: "She laid the map on the table.",
      chinese: "lay = 放置；她把地图放在桌上。",
    },
    "lead": {
      focusWord: "lead",
    ...
    "leave": {
      focusWord: "leave",
      sentence: "We left the office at six.",
      chinese: "leave = 离开；我们六点离开了办公室。",
    },
    "let": {
      focusWord: "let",
      sentence: "My parents let me stay up late.",
      chinese: "let = 允许；父母允许我晚睡。",
    },
    "listen": {
      focusWord: "listen",
      sentence: "Listen carefully to the instructions.",
      chinese: "listen = 听；仔细听说明。",
    },
    "live": {
      focusWord: "live",
      sentence: "My grandparents live near the coast.",
      chinese: "live = 居住；我的祖父母住在海岸附近。",
    },
    "locate": {
      focusWord: "locate",
      sentence: "The police located the missing bicycle.",
      chinese: "locate = 找到；警方找到了丢失的自行车。",
    },
    "look": {
      focusWord: "look",
      sentence: "You look tired today.",
      chinese: "look = 看起来；你今天看起来很累。",
    },
    "lookat": {
      focusWord: "look at",
      sentence: "Look at the timetable before you leave.",
      chinese: "look at = 查看；离开前看一下时间表。",
    },
    "lookfor": {
      focusWord: "look for",
      sentence: "I am looking for my keys.",
      chinese: "look for = 寻找；我正在找钥匙。",
    },
    "lookforwardto": {
      focusWord: "look forward to",
      sentence: "We look forward to seeing you.",
      chinese: "look forward to = 期待；我们期待见到你。",
    },
    "lookout": {
      focusWord: "look out",
      sentence: "Look out! There is a car coming.",
      chinese: "look out = 当心；当心！有辆车开过来了。",
    },
    "lookup": {
      focusWord: "look up",
      sentence: "Look up the word in a dictionary.",
      chinese: "look up = 查找；在词典里查一下这个词。",
    },
    "lose": {
      focusWord: "lose",
      sentence: "Be careful not to lose your ticket.",
      chinese: "lose = 丢失；小心别把票弄丢了。",
    },
    "madeofmaterial": {
      focusWord: "made of",
      sentence: "The table is made of wood.",
      chinese: "made of = 由...制成；这张桌子是木制的。",
    },
    "make": {
      focusWord: "make",
      sentence: "I made a sandwich for lunch.",
      chinese: "make = 制作；我做了一个三明治当午餐。",
    },
    "makesure": {
      focusWord: "make sure",
      sentence: "Make sure the door is locked.",
      chinese: "make sure = 确保；确保门已经锁好。",
    },
    "makeup": {
      focusWord: "make up",
      sentence: "He made up a funny story.",
      chinese: "make up = 编造；他编了一个有趣的故事。",
    },
    "manage": {
      focusWord: "manage",
      sentence: "She managed to finish on time.",
      chinese: "manage = 设法做到；她设法按时完成了。",
    },
    "marry": {
      focusWord: "marry",
      sentence: "They plan to marry next year.",
      chinese: "marry = 结婚；他们计划明年结婚。",
    },
    "mean": {
      focusWord: "mean",
      sentence: "What does this sign mean?",
      chinese: "mean = 意思是；这个标志是什么意思？",
    },
    "measure": {
      focusWord: "measure",
      sentence: "Measure the window before buying curtains.",
      chinese: "measure = 测量；买窗帘前先量一下窗户。",
    },
    "meet": {
      focusWord: "meet",
      sentence: "Let us meet outside the station.",
      chinese: "meet = 见面；我们在车站外见吧。",
    },
    "mend": {
      focusWord: "mend",
      sentence: "Can you mend this torn shirt?",
      chinese: "mend = 修补；你能补一下这件破衬衫吗？",
    },
    "miss": {
      focusWord: "miss",
    ...
    "mix": {
      focusWord: "mix",
      sentence: "Mix the flour and sugar together.",
      chinese: "mix = 混合；把面粉和糖混合在一起。",
    },
    "move": {
      focusWord: "move",
      sentence: "Please move the chair closer.",
      chinese: "move = 移动；请把椅子移近一点。",
    },
    "multiply": {
      focusWord: "multiply",
      sentence: "Multiply six by four.",
      chinese: "multiply = 乘；用六乘以四。",
    },
    "need": {
      focusWord: "need",
      sentence: "I need some help with this box.",
      chinese: "need = 需要；我需要有人帮忙搬这个箱子。",
    },
    "offer": {
      focusWord: "offer",
      sentence: "She offered me her seat.",
      chinese: "offer = 主动提供；她主动把座位让给我。",
    },
    "open": {
      focusWord: "open",
      sentence: "Could you open the window?",
      chinese: "open = 打开；你能打开窗户吗？",
    },
    "operate": {
      focusWord: "operate",
      sentence: "He knows how to operate the machine.",
      chinese: "operate = 操作；他知道怎样操作这台机器。",
    },
    "organise": {
      focusWord: "organise",
      sentence: "Our class organised a charity sale.",
      chinese: "organise = 组织；我们班组织了一次慈善义卖。",
    },
    "owe": {
      focusWord: "owe",
      sentence: "I owe my brother ten pounds.",
      chinese: "owe = 欠；我欠弟弟十英镑。",
    },
    "pack": {
      focusWord: "pack",
      sentence: "Pack your suitcase before dinner.",
      chinese: "pack = 收拾；晚饭前收拾好行李箱。",
    },
    "pause": {
      focusWord: "pause",
      sentence: "Pause the video while I take notes.",
      chinese: "pause = 暂停；我记笔记时请暂停视频。",
    },
    "peel": {
      focusWord: "peel",
      sentence: "Peel the potatoes before cooking them.",
      chinese: "peel = 削皮；烹饪前把土豆削皮。",
    },
    "perform": {
      focusWord: "perform",
      sentence: "The band performed three songs.",
      chinese: "perform = 表演；乐队表演了三首歌。",
    },
    "permit": {
      focusWord: "permit",
      sentence: "The school does not permit smoking.",
      chinese: "permit = 允许；学校不允许吸烟。",
    },
    "persuade": {
      focusWord: "persuade",
      sentence: "She persuaded me to take the course.",
      chinese: "persuade = 说服；她说服我参加这门课程。",
    },
    "pick": {
      focusWord: "pick",
      sentence: "Pick a card from the pack.",
      chinese: "pick = 挑选；从这副牌中挑一张。",
    },
    "pickup": {
      focusWord: "pick up",
      sentence: "I will pick up the parcel after work.",
      chinese: "pick up = 领取；我下班后去取包裹。",
    },
    "plan": {
      focusWord: "plan",
      sentence: "We are planning our summer holiday.",
      chinese: "plan = 计划；我们正在计划暑假。",
    },
    "postpone": {
      focusWord: "postpone",
      sentence: "They postponed the match because of rain.",
      chinese: "postpone = 推迟；他们因下雨推迟了比赛。",
    },
    "pour": {
      focusWord: "pour",
      sentence: "Pour the tea into the cups.",
      chinese: "pour = 倒；把茶倒进杯子里。",
    },
    "practise": {
      focusWord: "practise",
      sentence: "I practise the piano every evening.",
      chinese: "practise = 练习；我每天晚上练习钢琴。",
    },
    "pray": {
      focusWord: "pray",
      sentence: "They prayed for a safe journey.",
      chinese: "pray = 祈祷；他们祈祷旅途平安。",
    },
    "predict": {
      focusWord: "predict",
      sentence: "Experts predict more rain tomorrow.",
      chinese: "predict = 预测；专家预测明天会有更多降雨。",
    },
    "prepare": {
      focusWord: "prepare",
      sentence: "We prepared lunch for the visitors.",
      chinese: "prepare = 准备；我们为访客准备了午餐。",
    },
    "prizes": {
      focusWord: "prizes",
      sentence: "The prizes were presented after the race.",
      chinese: "prizes = 奖品；比赛结束后颁发了奖品。",
    },
    "press": {
      focusWord: "press",
      sentence: "Press the green button to start.",
      chinese: "press = 按；按绿色按钮启动。",
    },
    "prevent": {
      focusWord: "prevent",
      sentence: "The seat belt prevented a serious injury.",
      chinese: "prevent = 防止；安全带防止了严重受伤。",
    },
    "print": {
      focusWord: "print",
      sentence: "Please print your ticket before the trip.",
      chinese: "print = 打印；出发前请打印车票。",
    },
    "produce": {
      focusWord: "produce",
      sentence: "This factory produces electric bicycles.",
      chinese: "produce = 生产；这家工厂生产电动自行车。",
    },
    "promote": {
      focusWord: "promote",
      sentence: "The campaign promotes healthy eating.",
      chinese: "promote = 促进；这项活动倡导健康饮食。",
    },
    "protect": {
      focusWord: "protect",
      sentence: "This cream protects your skin from the sun.",
      chinese: "protect = 保护；这种乳霜保护皮肤免受阳光伤害。",
    },
    "prove": {
      focusWord: "prove",
      sentence: "Can you prove that the story is true?",
      chinese: "prove = 证明；你能证明这个故事是真的吗？",
    },
    "provide": {
      focusWord: "provide",
      sentence: "The hotel provides free breakfast.",
      chinese: "provide = 提供；这家酒店提供免费早餐。",
    },
    "publish": {
      focusWord: "publish",
      sentence: "The magazine publishes a new issue each month.",
      chinese: "publish = 出版；这本杂志每月出版一期。",
    },
    "pull": {
      focusWord: "pull",
      sentence: "Pull the door towards you.",
      chinese: "pull = 拉；把门朝你的方向拉。",
    },
    "punish": {
      focusWord: "punish",
      sentence: "The coach punished the players for arriving late.",
      chinese: "punish = 惩罚；教练因球员迟到而惩罚了他们。",
    },
    "put": {
      focusWord: "put",
      sentence: "Put your keys on the shelf.",
      chinese: "put = 放；把钥匙放在架子上。",
    },
    "putaway": {
      focusWord: "put away",
      sentence: "Please put away your toys.",
      chinese: "put away = 收好；请收好你的玩具。",
    },
    "putdown": {
      focusWord: "put down",
      sentence: "He put down the heavy box.",
      chinese: "put down = 放下；他放下了沉重的箱子。",
    },
    "putoff": {
      focusWord: "put off",
      sentence: "We had to put off the meeting.",
      chinese: "put off = 推迟；我们不得不推迟会议。",
    },
    "puton": {
      focusWord: "put on",
      sentence: "Put on your coat before you go outside.",
      chinese: "put on = 穿上；出门前穿上外套。",
    },
    "putout": {
      focusWord: "put out",
      sentence: "Firefighters put out the fire quickly.",
      chinese: "put out = 扑灭；消防员很快扑灭了大火。",
    },
    "putthrough": {
      focusWord: "put through",
      sentence: "Could you put me through to the manager?",
      chinese: "put through = 接通电话；你能帮我接通经理的电话吗？",
    },
    "putup": {
      focusWord: "put up",
      sentence: "We put up our tent beside the lake.",
      chinese: "put up = 搭起；我们在湖边搭起了帐篷。",
    },
    "quit": {
      focusWord: "quit",
      sentence: "He quit his job last month.",
      chinese: "quit = 辞去；他上个月辞去了工作。",
    },
    "raise": {
      focusWord: "raise",
      sentence: "Raise your hand if you know the answer.",
      chinese: "raise = 举起；如果你知道答案就举手。",
    },
    "reach": {
      focusWord: "reach",
      sentence: "We reached the station before noon.",
      chinese: "reach = 到达；我们中午前到达了车站。",
    },
    "react": {
      focusWord: "react",
      sentence: "How did she react to the news?",
      chinese: "react = 作出反应；她对这个消息有什么反应？",
    },
    "realise": {
      focusWord: "realise",
      sentence: "I realised that I had forgotten my wallet.",
      chinese: "realise = 意识到；我意识到自己忘带钱包了。",
    },
    "rebuild": {
      focusWord: "rebuild",
      sentence: "The town plans to rebuild the old bridge.",
      chinese: "rebuild = 重建；小镇计划重建那座旧桥。",
    },
    "receive": {
      focusWord: "receive",
      sentence: "I received your email this morning.",
      chinese: "receive = 收到；我今天早上收到了你的邮件。",
    },
    "recognise": {
      focusWord: "recognise",
      sentence: "I recognised an old friend in the crowd.",
      chinese: "recognise = 认出；我在人群中认出了一位老朋友。",
    },
    "recover": {
      focusWord: "recover",
      sentence: "She recovered quickly after her illness.",
      chinese: "recover = 康复；她生病后很快康复了。",
    },
    "reduce": {
      focusWord: "reduce",
      sentence: "We should reduce the amount of plastic we use.",
      chinese: "reduce = 减少；我们应该减少塑料用量。",
    },
    "refuse": {
      focusWord: "refuse",
      sentence: "He refused their offer politely.",
      chinese: "refuse = 拒绝；他礼貌地拒绝了他们的提议。",
    },
    "register": {
      focusWord: "register",
      sentence: "You can register for the course online.",
      chinese: "register = 注册；你可以在线报名这门课程。",
    },
    "relax": {
      focusWord: "relax",
      sentence: "I like to relax on the beach.",
      chinese: "relax = 放松；我喜欢在海滩上放松。",
    },
    "rely": {
      focusWord: "rely",
      sentence: "You can rely on Sara for help.",
      chinese: "rely = 依靠；你可以依靠萨拉的帮助。",
    },
    "remain": {
      focusWord: "remain",
      sentence: "Please remain calm during the test.",
      chinese: "remain = 保持；考试期间请保持冷静。",
    },
    "remember": {
      focusWord: "remember",
      sentence: "Remember to lock the door.",
      chinese: "remember = 记得；记得锁门。",
    },
    "remind": {
      focusWord: "remind",
      sentence: "Please remind me about the appointment.",
      chinese: "remind = 提醒；请提醒我赴约。",
    },
    "remove": {
      focusWord: "remove",
      sentence: "Remove your shoes before entering.",
      chinese: "remove = 脱掉；进入前请脱鞋。",
    },
    "repair": {
      focusWord: "repair",
      sentence: "They repaired the roof after the storm.",
      chinese: "repair = 修理；暴风雨后他们修好了屋顶。",
    },
    "repeat": {
      focusWord: "repeat",
      sentence: "Could you repeat the question?",
      chinese: "repeat = 重复；你能重复一下问题吗？",
    },
    "replace": {
      focusWord: "replace",
      sentence: "I need to replace the battery.",
      chinese: "replace = 更换；我需要更换电池。",
    },
    "require": {
      focusWord: "require",
      sentence: "This journey requires a passport.",
      chinese: "require = 需要；这趟旅程需要护照。",
    },
    "retire": {
      focusWord: "retire",
      sentence: "My aunt plans to retire next year.",
      chinese: "retire = 退休；我姑姑计划明年退休。",
    },
    "return": {
      focusWord: "return",
      sentence: "We returned home after midnight.",
      chinese: "return = 返回；我们午夜后回到家。",
    },
    "rise": {
      focusWord: "rise",
      sentence: "The sun rises behind the hills.",
      chinese: "rise = 升起；太阳从山后升起。",
    },
    "rob": {
      focusWord: "rob",
      sentence: "Two men robbed the shop last night.",
      chinese: "rob = 抢劫；两名男子昨晚抢劫了商店。",
    },
    "run": {
      focusWord: "run",
      sentence: "She runs five kilometres every morning.",
      chinese: "run = 跑；她每天早上跑五公里。",
    },
    "runout": {
      focusWord: "run out",
    ...
    "see": {
      focusWord: "see",
      sentence: "You can see the mountains from here.",
      chinese: "see = 看见；从这里可以看见群山。",
    },
    "seem": {
      focusWord: "seem",
      sentence: "You seem tired after the journey.",
      chinese: "seem = 似乎；旅程结束后你似乎很累。",
    },
    "select": {
      focusWord: "select",
      sentence: "Select one option from the menu.",
      chinese: "select = 选择；从菜单中选择一个选项。",
    },
    "send": {
      focusWord: "send",
      sentence: "I will send you the details by email.",
      chinese: "send = 发送；我会通过电子邮件把详情发给你。",
    },
    "serve": {
      focusWord: "serve",
      sentence: "Lunch is served at twelve.",
      chinese: "serve = 供应；午餐十二点供应。",
    },
    "set": {
      focusWord: "set",
      sentence: "I set my alarm for seven.",
      chinese: "set = 设定；我把闹钟设在七点。",
    },
    "setoff": {
      focusWord: "set off",
      sentence: "We set off early to avoid the traffic.",
      chinese: "set off = 出发；我们早早出发以避开交通拥堵。",
    },
    "setout": {
      focusWord: "set out",
      sentence: "The walkers set out before sunrise.",
      chinese: "set out = 动身；徒步者在日出前动身了。",
    },
    "setup": {
      focusWord: "set up",
      sentence: "They set up a new sports club.",
      chinese: "set up = 创办；他们创办了一个新的体育俱乐部。",
    },
    "sew": {
      focusWord: "sew",
      sentence: "Can you sew this button onto my shirt?",
      chinese: "sew = 缝；你能把这颗纽扣缝到我的衬衫上吗？",
    },
    "shake": {
      focusWord: "shake",
      sentence: "Shake the bottle before opening it.",
      chinese: "shake = 摇动；开瓶前摇一摇。",
    },
    "share": {
      focusWord: "share",
      sentence: "We shared the cake with our neighbours.",
      chinese: "share = 分享；我们和邻居分享了蛋糕。",
    },
    "shave": {
      focusWord: "shave",
      sentence: "He shaves every morning.",
      chinese: "shave = 刮胡子；他每天早上刮胡子。",
    },
    "shine": {
      focusWord: "shine",
      sentence: "The sun was shining through the window.",
      chinese: "shine = 照耀；阳光透过窗户照进来。",
    },
    "shoot": {
      focusWord: "shoot",
      sentence: "She shot a short video on her phone.",
      chinese: "shoot = 拍摄；她用手机拍了一段短视频。",
    },
    "signup": {
      focusWord: "sign up",
      sentence: "I signed up for a cooking course.",
      chinese: "sign up = 报名；我报名参加了烹饪课程。",
    },
    "sing": {
      focusWord: "sing",
      sentence: "We sang our favourite song.",
      chinese: "sing = 唱；我们唱了最喜欢的歌。",
    },
    "sit": {
      focusWord: "sit",
      sentence: "I sat near the window.",
      chinese: "sit = 坐；我坐在窗边。",
    },
    "slip": {
      focusWord: "slip",
      sentence: "He slipped on the wet floor.",
      chinese: "slip = 滑倒；他在湿地板上滑倒了。",
    },
    "sort": {
      focusWord: "sort",
      sentence: "Please sort the bottles for recycling.",
      chinese: "sort = 分类；请把瓶子分类回收。",
    },
    "spell": {
      focusWord: "spell",
      sentence: "How do you spell your surname?",
      chinese: "spell = 拼写；你的姓怎么拼？",
    },
    "spend": {
      focusWord: "spend",
      sentence: "We spent the weekend in London.",
      chinese: "spend = 度过；我们在伦敦度过了周末。",
    },
    "spill": {
      focusWord: "spill",
      sentence: "I spilled juice on the table.",
      chinese: "spill = 洒出；我把果汁洒在桌上了。",
    },
    "spoil": {
      focusWord: "spoil",
      sentence: "Do not spoil the surprise.",
      chinese: "spoil = 破坏；别破坏这个惊喜。",
    },
    "stand": {
      focusWord: "stand",
      sentence: "We stood in a queue for tickets.",
      chinese: "stand = 站立；我们排队站着等票。",
    },
    "start": {
      focusWord: "start",
      sentence: "The class starts at half past nine.",
      chinese: "start = 开始；课程九点半开始。",
    },
    "stay": {
      focusWord: "stay",
      sentence: "We stayed at a small hotel.",
      chinese: "stay = 停留；我们住在一家小旅馆。",
    },
    "staybehind": {
      focusWord: "stay behind",
      sentence: "Two students stayed behind after class.",
      chinese: "stay behind = 留下；两名学生课后留了下来。",
    },
    "steal": {
      focusWord: "steal",
      sentence: "Someone stole my bicycle.",
      chinese: "steal = 偷；有人偷了我的自行车。",
    },
    "stepforwardbackout": {
      focusWord: "step forward",
      sentence: "Please step forward when your name is called.",
      chinese: "step forward = 向前走；叫到你的名字时请向前走。",
    },
    "stir": {
      focusWord: "stir",
      sentence: "Stir the soup before serving it.",
      chinese: "stir = 搅拌；上汤前先搅一搅。",
    },
    "stop": {
      focusWord: "stop",
      sentence: "The driver stopped the car safely.",
      chinese: "stop = 停下；司机安全地停下了车。",
    },
    "subtract": {
      focusWord: "subtract",
      sentence: "Subtract four from ten.",
      chinese: "subtract = 减去；从十中减去四。",
    },
    "succeed": {
      focusWord: "succeed",
      sentence: "She succeeded in passing the exam.",
      chinese: "succeed = 成功；她成功通过了考试。",
    },
    "suffer": {
      focusWord: "suffer",
      sentence: "He suffers from frequent headaches.",
      chinese: "suffer = 遭受；他经常头痛。",
    },
    "suggest": {
      focusWord: "suggest",
      sentence: "I suggest having a picnic tomorrow.",
      chinese: "suggest = 建议；我建议明天去野餐。",
    },
    "sunbathe": {
      focusWord: "sunbathe",
      sentence: "We sunbathed on the beach all afternoon.",
      chinese: "sunbathe = 晒日光浴；我们整个下午都在海滩上晒太阳。",
    },
    "supply": {
      focusWord: "supply",
      sentence: "Local farms supply the restaurant with vegetables.",
      chinese: "supply = 供应；当地农场为餐厅供应蔬菜。",
    },
    "suppose": {
      focusWord: "suppose",
      sentence: "I suppose he is busy today.",
      chinese: "suppose = 认为；我想他今天很忙。",
    },
    "surf": {
      focusWord: "surf",
      sentence: "They surf near the beach every weekend.",
      chinese: "surf = 冲浪；他们每周末都在海滩附近冲浪。",
    },
    "surround": {
      focusWord: "surround",
      sentence: "Tall trees surround the house.",
      chinese: "surround = 环绕；高大的树木环绕着房子。",
    },
    "take": {
      focusWord: "take",
      sentence: "Take an umbrella in case it rains.",
      chinese: "take = 带上；带把伞，以防下雨。",
    },
    "takecareof": {
      focusWord: "take care of",
      sentence: "Can you take care of my cat?",
      chinese: "take care of = 照顾；你能照顾我的猫吗？",
    },
    "takeoff": {
      focusWord: "take off",
      sentence: "Please take off your shoes.",
      chinese: "take off = 脱下；请脱鞋。",
    },
    "takepart": {
      focusWord: "take part",
      sentence: "More than a hundred people took part in the race.",
      chinese: "take part = 参加；一百多人参加了比赛。",
    },
    "takeup": {
      focusWord: "take up",
      sentence: "She took up tennis last summer.",
      chinese: "take up = 开始从事；她去年夏天开始打网球。",
    },
    "think": {
      focusWord: "think",
      sentence: "I need time to think about your offer.",
      chinese: "think = 考虑；我需要时间考虑你的提议。",
    },
    "throw": {
      focusWord: "throw",
      sentence: "Throw the ball to me.",
      chinese: "throw = 扔；把球扔给我。",
    },
    "touch": {
      focusWord: "touch",
      sentence: "Do not touch the wet paint.",
      chinese: "touch = 触碰；不要碰未干的油漆。",
    },
    "transfer": {
      focusWord: "transfer",
      sentence: "I transferred the money online.",
      chinese: "transfer = 转账；我在网上转了账。",
    },
    "try": {
      focusWord: "try",
      sentence: "Try again if the answer is wrong.",
      chinese: "try = 尝试；如果答案错了就再试一次。",
    },
    "tryon": {
      focusWord: "try on",
      sentence: "Can I try on this jacket?",
      chinese: "try on = 试穿；我能试穿这件夹克吗？",
    },
    "turn": {
      focusWord: "turn",
      sentence: "Turn left at the traffic lights.",
      chinese: "turn = 转弯；在红绿灯处左转。",
    },
    "turndown": {
      focusWord: "turn down",
      sentence: "She turned down the job offer.",
      chinese: "turn down = 拒绝；她拒绝了那份工作邀请。",
    },
    "turninto": {
      focusWord: "turn into",
      sentence: "The water turned into ice.",
      chinese: "turn into = 变成；水变成了冰。",
    },
    "turnoff": {
      focusWord: "turn off",
      sentence: "Turn off the light when you leave.",
      chinese: "turn off = 关掉；离开时关灯。",
    },
    "turnon": {
      focusWord: "turn on",
      sentence: "Turn on the oven before you start cooking.",
      chinese: "turn on = 打开；开始做饭前打开烤箱。",
    },
    "turnup": {
      focusWord: "turn up",
      sentence: "Could you turn up the music?",
      chinese: "turn up = 调大；你能把音乐声调大吗？",
    },
    "underline": {
      focusWord: "underline",
      sentence: "Underline the correct answer.",
      chinese: "underline = 在...下面划线；在正确答案下面划线。",
    },
    "undress": {
      focusWord: "undress",
      sentence: "The child undressed before bed.",
      chinese: "undress = 脱衣服；孩子睡前脱了衣服。",
    },
    "unpack": {
      focusWord: "unpack",
      sentence: "We unpacked our suitcases at the hotel.",
      chinese: "unpack = 打开行李；我们在酒店打开行李箱整理东西。",
    },
    "update": {
      focusWord: "update",
      sentence: "Please update your address online.",
      chinese: "update = 更新；请在线更新你的地址。",
    },
    "use": {
      focusWord: "use",
      sentence: "You can use this app to book tickets.",
      chinese: "use = 使用；你可以用这个应用程序订票。",
    },
    "visit": {
      focusWord: "visit",
      sentence: "We visited the science museum yesterday.",
      chinese: "visit = 参观；我们昨天参观了科学博物馆。",
    },
    "wait": {
      focusWord: "wait",
      sentence: "We waited twenty minutes for the bus.",
      chinese: "wait = 等待；我们等公交车等了二十分钟。",
    },
    "wake": {
      focusWord: "wake",
      sentence: "Please wake me at six tomorrow.",
      chinese: "wake = 叫醒；明天六点请叫醒我。",
    },
    "walk": {
      focusWord: "walk",
      sentence: "I walk to school every day.",
      chinese: "walk = 步行；我每天步行上学。",
    },
    "want": {
      focusWord: "want",
      sentence: "I want a new bicycle for my birthday.",
      chinese: "want = 想要；我生日想要一辆新自行车。",
    },
    "warn": {
      focusWord: "warn",
      sentence: "They warned us about the storm.",
      chinese: "warn = 警告；他们警告我们暴风雨要来了。",
    },
    "watch": {
      focusWord: "watch",
      sentence: "We watched a film after dinner.",
      chinese: "watch = 观看；晚饭后我们看了一部电影。",
    },
    "weigh": {
      focusWord: "weigh",
      sentence: "Please weigh the parcel before posting it.",
      chinese: "weigh = 称重；寄包裹前请先称重。",
    },
    "win": {
      focusWord: "win",
      sentence: "Our team won the match.",
      chinese: "win = 赢得；我们队赢得了比赛。",
    },
    "wonder": {
      focusWord: "wonder",
      sentence: "I wonder where he went.",
      chinese: "wonder = 想知道；我想知道他去了哪里。",
    },
    "wrap": {
      focusWord: "wrap",
      sentence: "She wrapped the gift in blue paper.",
      chinese: "wrap = 包裹；她用蓝色纸把礼物包了起来。",
    },
  };
}
